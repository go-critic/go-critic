	...
	RuleGroups: []ir.RuleGroup{
		...
		},
		{
			...
			Rules: []ir.Rule{
				...
				{
					Line:           166,
					SyntaxPatterns: []ir.PatternString{{Line: 166, Value: "len($s) > 0"}},
					ReportTemplate: "replace `$$` with `$s != \"\"`",
					WhereExpr: ir.FilterExpr{
						Line:  167,
						Op:    ir.FilterVarTypeIsOp,
						Src:   "m[\"s\"].Type.Is(`string`)",
						Value: "s",
						Args:  []ir.FilterExpr{{Line: 167, Op: ir.FilterStringOp, Src: "`string`", Value: "string"}},
					},
				},
				{
					Line:           170,
				...
				{
					Line:           173,
					SyntaxPatterns: []ir.PatternString{{Line: 173, Value: "len($s) <= 0"}},
					ReportTemplate: "replace `$$` with `$s == \"\"`",
					WhereExpr: ir.FilterExpr{
						Line:  174,
						Op:    ir.FilterVarTypeIsOp,
				...
				{
					Line:           176,
					SyntaxPatterns: []ir.PatternString{{Line: 176, Value: "len($s) < 0"}},
					ReportTemplate: "replace `$$` with `$s == \"\"`",
					WhereExpr: ir.FilterExpr{
						Line:  177,
						Op:    ir.FilterVarTypeIsOp,
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:           186,
					SyntaxPatterns: []ir.PatternString{{Line: 186, Value: "copy($_, []byte($s))"}},
					ReportTemplate: "can simplify `[]byte($s)` to `$s`",
				},
				{
					Line:            188,
					SyntaxPatterns:  []ir.PatternString{{Line: 188, Value: "string($b) == \"\""}},
				...
				{
					Line:            189,
					SyntaxPatterns:  []ir.PatternString{{Line: 189, Value: "string($b) != \"\""}},
					ReportTemplate:  "suggestion: len($b) != 0",
					SuggestTemplate: "len($b) != 0",
					WhereExpr: ir.FilterExpr{
						Line:  189,
						...
						Src:   "m[\"b\"].Type.Is(`[]byte`)",
						Value: "b",
						Args:  []ir.FilterExpr{{Line: 189, Op: ir.FilterStringOp, Src: "`[]byte`", Value: "[]byte"}},
					},
				},
				{
					Line:            191,
					SyntaxPatterns:  []ir.PatternString{{Line: 191, Value: "len(string($b))"}},
				...
				{
					Line:            193,
					SyntaxPatterns:  []ir.PatternString{{Line: 193, Value: "string($x) == string($y)"}},
						...
						Args: []ir.FilterExpr{
							{
								...
								Value: "x",
								Args:  []ir.FilterExpr{{Line: 194, Op: ir.FilterStringOp, Src: "`[]byte`", Value: "[]byte"}},
							},
							{
								Line:  194,
								Op:    ir.FilterVarTypeIsOp,
				...
				{
					Line:            197,
					SyntaxPatterns:  []ir.PatternString{{Line: 197, Value: "string($x) != string($y)"}},
					ReportTemplate:  "suggestion: !bytes.Equal($x, $y)",
					SuggestTemplate: "!bytes.Equal($x, $y)",
					WhereExpr: ir.FilterExpr{
						Line: 198,
						...
						Args: []ir.FilterExpr{
							{
								...
								Src:   "m[\"x\"].Type.Is(`[]byte`)",
								Value: "x",
								Args:  []ir.FilterExpr{{Line: 198, Op: ir.FilterStringOp, Src: "`[]byte`", Value: "[]byte"}},
							},
							{
								Line:  198,
								Op:    ir.FilterVarTypeIsOp,
				...
				{
					Line:            201,
					SyntaxPatterns:  []ir.PatternString{{Line: 201, Value: "$re.Match([]byte($s))"}},
						...
						Args: []ir.FilterExpr{
							{
								...
								Value: "re",
								Args:  []ir.FilterExpr{{Line: 202, Op: ir.FilterStringOp, Src: "`*regexp.Regexp`", Value: "*regexp.Regexp"}},
							},
							{
								Line:  202,
								Op:    ir.FilterVarTypeIsOp,
								Src:   "m[\"s\"].Type.Is(`string`)",
								Value: "s",
								Args:  []ir.FilterExpr{{Line: 202, Op: ir.FilterStringOp, Src: "`string`", Value: "string"}},
							},
						},
					},
				},
				{
					Line:            205,
					SyntaxPatterns:  []ir.PatternString{{Line: 205, Value: "$re.FindIndex([]byte($s))"}},
						...
						Args: []ir.FilterExpr{
							{
								...
								Src:   "m[\"re\"].Type.Is(`*regexp.Regexp`)",
								Value: "re",
								Args:  []ir.FilterExpr{{Line: 206, Op: ir.FilterStringOp, Src: "`*regexp.Regexp`", Value: "*regexp.Regexp"}},
							},
							{
								Line:  206,
								Op:    ir.FilterVarTypeIsOp,
								Src:   "m[\"s\"].Type.Is(`string`)",
								Value: "s",
								Args:  []ir.FilterExpr{{Line: 206, Op: ir.FilterStringOp, Src: "`string`", Value: "string"}},
							},
						},
					},
				},
				{
					Line:            209,
					SyntaxPatterns:  []ir.PatternString{{Line: 209, Value: "$re.FindAllIndex([]byte($s), $n)"}},
						...
						Args: []ir.FilterExpr{
							{
								...
								Src:   "m[\"re\"].Type.Is(`*regexp.Regexp`)",
								Value: "re",
								Args:  []ir.FilterExpr{{Line: 210, Op: ir.FilterStringOp, Src: "`*regexp.Regexp`", Value: "*regexp.Regexp"}},
							},
							{
								Line:  210,
								Op:    ir.FilterVarTypeIsOp,
								Src:   "m[\"s\"].Type.Is(`string`)",
								Value: "s",
								Args:  []ir.FilterExpr{{Line: 210, Op: ir.FilterStringOp, Src: "`string`", Value: "string"}},
							},
						},
					},
				},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line:           220,
				SyntaxPatterns: []ir.PatternString{{Line: 220, Value: "strings.Index(string($x), $y)"}},
				...
				WhereExpr: ir.FilterExpr{
					...
					Args: []ir.FilterExpr{
						{Line: 221, Op: ir.FilterVarPureOp, Src: "m[\"x\"].Pure", Value: "x"},
						{Line: 221, Op: ir.FilterVarPureOp, Src: "m[\"y\"].Pure", Value: "y"},
					},
				},
			}},
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:           230,
					SyntaxPatterns: []ir.PatternString{{Line: 230, Value: "$wg.Add(-1)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "wg",
						Args:  []ir.FilterExpr{{Line: 231, Op: ir.FilterStringOp, Src: "`sync.WaitGroup`", Value: "sync.WaitGroup"}},
					},
				},
				{
					Line:           234,
					SyntaxPatterns: []ir.PatternString{{Line: 234, Value: "$buf.Truncate(0)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "buf",
						Args:  []ir.FilterExpr{{Line: 235, Op: ir.FilterStringOp, Src: "`bytes.Buffer`", Value: "bytes.Buffer"}},
					},
				},
				{
					Line:           238,
					SyntaxPatterns: []ir.PatternString{{Line: 238, Value: "http.HandlerFunc(http.NotFound)"}},
					ReportTemplate: "use http.NotFoundHandler method in `$$`",
				},
				{
					Line:           240,
					SyntaxPatterns: []ir.PatternString{{Line: 240, Value: "strings.SplitN($_, $_, -1)"}},
					ReportTemplate: "use strings.Split method in `$$`",
				},
				{
					Line:           241,
					SyntaxPatterns: []ir.PatternString{{Line: 241, Value: "strings.Replace($_, $_, $_, -1)"}},
					ReportTemplate: "use strings.ReplaceAll method in `$$`",
				},
				{
					Line:           242,
					SyntaxPatterns: []ir.PatternString{{Line: 242, Value: "strings.Map(unicode.ToTitle, $_)"}},
					ReportTemplate: "use strings.ToTitle method in `$$`",
				},
				{
					Line: 243,
					SyntaxPatterns: []ir.PatternString{
						{Line: 243, Value: "strings.Index($s1, $s2) >= 0"},
						{Line: 243, Value: "strings.Index($s1, $s2) != -1"},
					},
				...
				},
				{
					Line: 244,
					SyntaxPatterns: []ir.PatternString{
						{Line: 244, Value: "strings.IndexAny($s1, $s2) >= 0"},
						{Line: 244, Value: "strings.IndexAny($s1, $s2) != -1"},
					},
				...
				},
				{
					Line: 245,
					SyntaxPatterns: []ir.PatternString{
						{Line: 245, Value: "strings.IndexRune($s1, $s2) >= 0"},
						{Line: 245, Value: "strings.IndexRune($s1, $s2) != -1"},
					},
				...
				},
				{
					Line: 247,
					SyntaxPatterns: []ir.PatternString{
						{Line: 247, Value: "$i := strings.Index($s, $sep); $*_; $x, $y = $s[:$i], $s[$i+1:]"},
						{Line: 248, Value: "$i := strings.Index($s, $sep); $*_; $x = $s[:$i]; $*_; $y = $s[$i+1:]"},
					},
				...
				},
				{
					Line: 252,
					SyntaxPatterns: []ir.PatternString{
						{Line: 253, Value: "if $i := strings.Index($s, $sep); $i != -1 { $*_; $x, $y = $s[:$i], $s[$i+1:]; $*_ }"},
						{Line: 254, Value: "if $i := strings.Index($s, $sep); $i != -1 { $*_; $x = $s[:$i]; $*_; $y = $s[$i+1:]; $*_ }"},
						{Line: 255, Value: "if $i := strings.Index($s, $sep); $i >= 0 { $*_; $x, $y = $s[:$i], $s[$i+1:]; $*_ }"},
						{Line: 256, Value: "if $i := strings.Index($s, $sep); $i >= 0 { $*_; $x = $s[:$i]; $*_; $y = $s[$i+1:]; $*_ }"},
					},
				...
				{
					Line:           260,
					SyntaxPatterns: []ir.PatternString{{Line: 260, Value: "bytes.SplitN(b, []byte(\".\"), -1)"}},
					ReportTemplate: "use bytes.Split method in `$$`",
				},
				{
					Line:           261,
					SyntaxPatterns: []ir.PatternString{{Line: 261, Value: "bytes.Replace($_, $_, $_, -1)"}},
					ReportTemplate: "use bytes.ReplaceAll method in `$$`",
				},
				{
					Line:           262,
					SyntaxPatterns: []ir.PatternString{{Line: 262, Value: "bytes.Map(unicode.ToUpper, $_)"}},
					ReportTemplate: "use bytes.ToUpper method in `$$`",
				},
				{
					Line:           263,
					SyntaxPatterns: []ir.PatternString{{Line: 263, Value: "bytes.Map(unicode.ToLower, $_)"}},
					ReportTemplate: "use bytes.ToLower method in `$$`",
				},
				{
					Line:           264,
					SyntaxPatterns: []ir.PatternString{{Line: 264, Value: "bytes.Map(unicode.ToTitle, $_)"}},
					ReportTemplate: "use bytes.ToTitle method in `$$`",
				},
				{
					Line: 265,
					SyntaxPatterns: []ir.PatternString{
						{Line: 265, Value: "bytes.Index($b1, $b2) >= 0"},
						{Line: 265, Value: "bytes.Index($b1, $b2) != -1"},
					},
				...
				},
				{
					Line: 266,
					SyntaxPatterns: []ir.PatternString{
						{Line: 266, Value: "bytes.IndexAny($b1, $b2) >= 0"},
						{Line: 266, Value: "bytes.IndexAny($b1, $b2) != -1"},
					},
				...
				},
				{
					Line: 267,
					SyntaxPatterns: []ir.PatternString{
						{Line: 267, Value: "bytes.IndexRune($b1, $b2) >= 0"},
						{Line: 267, Value: "bytes.IndexRune($b1, $b2) != -1"},
					},
				...
				{
					Line:           269,
					SyntaxPatterns: []ir.PatternString{{Line: 269, Value: "draw.DrawMask($_, $_, $_, $_, nil, image.Point{}, $_)"}},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:           278,
					SyntaxPatterns: []ir.PatternString{{Line: 278, Value: "regexp.Compile($pat)"}},
				...
				{
					Line:           282,
					SyntaxPatterns: []ir.PatternString{{Line: 282, Value: "regexp.CompilePOSIX($pat)"}},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:           292,
					SyntaxPatterns: []ir.PatternString{{Line: 292, Value: "strings.Replace($_, $_, $_, $zero)"}},
				...
				{
					Line:           295,
					SyntaxPatterns: []ir.PatternString{{Line: 295, Value: "bytes.Replace($_, $_, $_, $zero)"}},
					ReportTemplate: "suspicious arg 0, probably meant -1",
					WhereExpr: ir.FilterExpr{
						Line: 296,
						Op:   ir.FilterEqOp,
				...
				{
					Line:           299,
					SyntaxPatterns: []ir.PatternString{{Line: 299, Value: "strings.SplitN($_, $_, $zero)"}},
					ReportTemplate: "suspicious arg 0, probably meant -1",
					WhereExpr: ir.FilterExpr{
						Line: 300,
						Op:   ir.FilterEqOp,
				...
				{
					Line:           302,
					SyntaxPatterns: []ir.PatternString{{Line: 302, Value: "bytes.SplitN($_, $_, $zero)"}},
					ReportTemplate: "suspicious arg 0, probably meant -1",
					WhereExpr: ir.FilterExpr{
						Line: 303,
						Op:   ir.FilterEqOp,
				...
				{
					Line:           306,
					SyntaxPatterns: []ir.PatternString{{Line: 306, Value: "append($_)"}},
					ReportTemplate: "no-op append call, probably missing arguments",
				},
				{
					Line:           308,
					SyntaxPatterns: []ir.PatternString{{Line: 308, Value: "filepath.Join($_)"}},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line:           341,
				SyntaxPatterns: []ir.PatternString{{Line: 341, Value: "$w.WriteRune($c)"}},
					...
					Args: []ir.FilterExpr{
						{
							...
							Value: "w",
							Args:  []ir.FilterExpr{{Line: 342, Op: ir.FilterStringOp, Src: "\"io.ByteWriter\"", Value: "io.ByteWriter"}},
						},
						{
							Line: 342,
							Op:   ir.FilterAndOp,
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            351,
					SyntaxPatterns:  []ir.PatternString{{Line: 351, Value: "$w.Write([]byte(fmt.Sprint($*args)))"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "w",
						Args:  []ir.FilterExpr{{Line: 352, Op: ir.FilterStringOp, Src: "\"io.Writer\"", Value: "io.Writer"}},
					},
				},
				{
					Line:            356,
					SyntaxPatterns:  []ir.PatternString{{Line: 356, Value: "$w.Write([]byte(fmt.Sprintf($*args)))"}},
				...
				{
					Line:            361,
					SyntaxPatterns:  []ir.PatternString{{Line: 361, Value: "$w.Write([]byte(fmt.Sprintln($*args)))"}},
				...
				{
					Line:            366,
					SyntaxPatterns:  []ir.PatternString{{Line: 366, Value: "io.WriteString($w, fmt.Sprint($*args))"}},
					ReportTemplate:  "suggestion: fmt.Fprint($w, $args)",
					SuggestTemplate: "fmt.Fprint($w, $args)",
				},
				{
					Line:            367,
					SyntaxPatterns:  []ir.PatternString{{Line: 367, Value: "io.WriteString($w, fmt.Sprintf($*args))"}},
					ReportTemplate:  "suggestion: fmt.Fprintf($w, $args)",
					SuggestTemplate: "fmt.Fprintf($w, $args)",
				},
				{
					Line:            368,
					SyntaxPatterns:  []ir.PatternString{{Line: 368, Value: "io.WriteString($w, fmt.Sprintln($*args))"}},
					ReportTemplate:  "suggestion: fmt.Fprintln($w, $args)",
					SuggestTemplate: "fmt.Fprintln($w, $args)",
				},
				{
					Line:            370,
					SyntaxPatterns:  []ir.PatternString{{Line: 370, Value: "$w.WriteString(fmt.Sprint($*args))"}},
					ReportTemplate:  "suggestion: fmt.Fprint($w, $args)",
					SuggestTemplate: "fmt.Fprint($w, $args)",
					WhereExpr: ir.FilterExpr{
						Line: 371,
				...
				{
					Line:            373,
					SyntaxPatterns:  []ir.PatternString{{Line: 373, Value: "$w.WriteString(fmt.Sprintf($*args))"}},
					ReportTemplate:  "suggestion: fmt.Fprintf($w, $args)",
					SuggestTemplate: "fmt.Fprintf($w, $args)",
					WhereExpr: ir.FilterExpr{
						Line: 374,
						...
						Args: []ir.FilterExpr{
							...
							},
							{
								...
								Src:   "m[\"w\"].Type.Implements(\"io.StringWriter\")",
								Value: "w",
								Args:  []ir.FilterExpr{{Line: 374, Op: ir.FilterStringOp, Src: "\"io.StringWriter\"", Value: "io.StringWriter"}},
							},
						},
					},
				},
				{
					Line:            376,
					SyntaxPatterns:  []ir.PatternString{{Line: 376, Value: "$w.WriteString(fmt.Sprintln($*args))"}},
					ReportTemplate:  "suggestion: fmt.Fprintln($w, $args)",
					SuggestTemplate: "fmt.Fprintln($w, $args)",
					WhereExpr: ir.FilterExpr{
						Line: 377,
						...
						Args: []ir.FilterExpr{
							{
								...
								Src:   "m[\"w\"].Type.Implements(\"io.Writer\")",
								Value: "w",
								Args:  []ir.FilterExpr{{Line: 377, Op: ir.FilterStringOp, Src: "\"io.Writer\"", Value: "io.Writer"}},
							},
							{
								Line:  377,
								Op:    ir.FilterVarTypeImplementsOp,
								Src:   "m[\"w\"].Type.Implements(\"io.StringWriter\")",
								Value: "w",
								Args:  []ir.FilterExpr{{Line: 377, Op: ir.FilterStringOp, Src: "\"io.StringWriter\"", Value: "io.StringWriter"}},
							},
						},
					},
				},
			...
			Rules: []ir.Rule{
				{
					Line: 386,
					SyntaxPatterns: []ir.PatternString{
						{Line: 386, Value: "$x.Equal($x)"},
						{Line: 386, Value: "$x.Equals($x)"},
						{Line: 386, Value: "$x.Compare($x)"},
						{Line: 386, Value: "$x.Cmp($x)"},
					},
					ReportTemplate: "suspicious method call with the same argument and receiver",
					WhereExpr:      ir.FilterExpr{Line: 387, Op: ir.FilterVarPureOp, Src: "m[\"x\"].Pure", Value: "x"},
				},
				{
					Line: 390,
					SyntaxPatterns: []ir.PatternString{
						{Line: 390, Value: "copy($x, $x)"},
						{Line: 391, Value: "math.Max($x, $x)"},
						{Line: 392, Value: "math.Min($x, $x)"},
						{Line: 393, Value: "reflect.Copy($x, $x)"},
						{Line: 394, Value: "reflect.DeepEqual($x, $x)"},
						{Line: 395, Value: "strings.Contains($x, $x)"},
						{Line: 396, Value: "strings.Compare($x, $x)"},
						{Line: 397, Value: "strings.EqualFold($x, $x)"},
						{Line: 398, Value: "strings.HasPrefix($x, $x)"},
						{Line: 399, Value: "strings.HasSuffix($x, $x)"},
						{Line: 400, Value: "strings.Index($x, $x)"},
						{Line: 401, Value: "strings.LastIndex($x, $x)"},
						{Line: 402, Value: "strings.Split($x, $x)"},
						{Line: 403, Value: "strings.SplitAfter($x, $x)"},
						{Line: 404, Value: "strings.SplitAfterN($x, $x, $_)"},
						{Line: 405, Value: "strings.SplitN($x, $x, $_)"},
						{Line: 406, Value: "strings.Replace($_, $x, $x, $_)"},
						{Line: 407, Value: "strings.ReplaceAll($_, $x, $x)"},
						{Line: 408, Value: "bytes.Contains($x, $x)"},
						{Line: 409, Value: "bytes.Compare($x, $x)"},
						{Line: 410, Value: "bytes.Equal($x, $x)"},
						{Line: 411, Value: "bytes.EqualFold($x, $x)"},
						{Line: 412, Value: "bytes.HasPrefix($x, $x)"},
						{Line: 413, Value: "bytes.HasSuffix($x, $x)"},
						{Line: 414, Value: "bytes.Index($x, $x)"},
						{Line: 415, Value: "bytes.LastIndex($x, $x)"},
						{Line: 416, Value: "bytes.Split($x, $x)"},
						{Line: 417, Value: "bytes.SplitAfter($x, $x)"},
						{Line: 418, Value: "bytes.SplitAfterN($x, $x, $_)"},
						{Line: 419, Value: "bytes.SplitN($x, $x, $_)"},
						{Line: 420, Value: "bytes.Replace($_, $x, $x, $_)"},
						{Line: 421, Value: "bytes.ReplaceAll($_, $x, $x)"},
						{Line: 422, Value: "types.Identical($x, $x)"},
						{Line: 423, Value: "types.IdenticalIgnoreTags($x, $x)"},
						{Line: 424, Value: "draw.Draw($x, $_, $x, $_, $_)"},
					},
					ReportTemplate: "suspicious duplicated args in $$",
					WhereExpr:      ir.FilterExpr{Line: 425, Op: ir.FilterVarPureOp, Src: "m[\"x\"].Pure", Value: "x"},
				},
			},
		},
		{
			...
			Rules: []ir.Rule{{
				Line:           434,
				SyntaxPatterns: []ir.PatternString{{Line: 434, Value: "if $_ { $*_; http.Error($w, $err, $code) }"}},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line:            444,
				SyntaxPatterns:  []ir.PatternString{{Line: 444, Value: "$x + string(os.PathSeparator) + $y"}},
					...
					Args: []ir.FilterExpr{
						{
							...
							Src:   "m[\"x\"].Type.Is(`string`)",
							Value: "x",
							Args:  []ir.FilterExpr{{Line: 445, Op: ir.FilterStringOp, Src: "`string`", Value: "string"}},
						},
						{
							Line:  445,
							Op:    ir.FilterVarTypeIsOp,
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            455,
					SyntaxPatterns:  []ir.PatternString{{Line: 455, Value: "$w.Write([]byte($s))"}},
				...
				{
					Line:            460,
					SyntaxPatterns:  []ir.PatternString{{Line: 460, Value: "io.WriteString($w, $s)"}},
					ReportTemplate:  "$w.WriteString($s) should be preferred to the $$",
					SuggestTemplate: "$w.WriteString($s)",
					WhereExpr: ir.FilterExpr{
						Line:  461,
						...
						Src:   "m[\"w\"].Type.Implements(\"io.StringWriter\")",
						Value: "w",
						Args:  []ir.FilterExpr{{Line: 461, Op: ir.FilterStringOp, Src: "\"io.StringWriter\"", Value: "io.StringWriter"}},
					},
				},
			},
		},
		{
			...
			Rules: []ir.Rule{{
				Line:           471,
				SyntaxPatterns: []ir.PatternString{{Line: 471, Value: "for $i := 0; $i < len($xs); $i++ { $xs[$i] = $zero }"}},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line:           481,
				SyntaxPatterns: []ir.PatternString{{Line: 481, Value: "$_, $ok := $m.Load($k); if $ok { $m.Delete($k); $*_ }"}},
				...
				WhereExpr: ir.FilterExpr{
					...
					Args: []ir.FilterExpr{
						...
						},
						{
							...
							Value: "m",
							Args:  []ir.FilterExpr{{Line: 483, Op: ir.FilterStringOp, Src: "`*sync.Map`", Value: "*sync.Map"}},
						},
					},
				},
			}},
		},
		{
			...
			Rules: []ir.Rule{{
				Line:           492,
				SyntaxPatterns: []ir.PatternString{{Line: 492, Value: "fmt.Sprintf($s, $*_)"}},
				...
				WhereExpr: ir.FilterExpr{
					...
					Args: []ir.FilterExpr{
						...
						},
						{
							...
							Src:   "m[\"s\"].Text.Matches(`^\".*\\\\\"%s\\\\\".*\"$`)",
							Value: "s",
							Args:  []ir.FilterExpr{{Line: 494, Op: ir.FilterStringOp, Src: "`^\".*\\\\\"%s\\\\\".*\"$`", Value: "^\".*\\\\\"%s\\\\\".*\"$"}},
						},
					},
				},
			}},
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            503,
					SyntaxPatterns:  []ir.PatternString{{Line: 503, Value: "$x[len($x)]"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Args: []ir.FilterExpr{
							{Line: 504, Op: ir.FilterVarPureOp, Src: "m[\"x\"].Pure", Value: "x"},
							{
								Line:  504,
								Op:    ir.FilterVarTypeIsOp,
								Src:   "m[\"x\"].Type.Is(`[]$_`)",
								Value: "x",
								Args:  []ir.FilterExpr{{Line: 504, Op: ir.FilterStringOp, Src: "`[]$_`", Value: "[]$_"}},
							},
						},
					},
				},
				...
				},
				{
					...
					SyntaxPatterns: []ir.PatternString{
						...
						{Line: 522, Value: "$i := strings.Index($s, $_); $_ = $slicing[:$i]"},
						{Line: 523, Value: "$i := bytes.Index($s, $_); $_ := $slicing[:$i]"},
						{Line: 524, Value: "$i := bytes.Index($s, $_); $_ = $slicing[:$i]"},
					},
					ReportTemplate: "Index() can return -1; maybe you wanted to do $s[:$i+1]",
					WhereExpr: ir.FilterExpr{
						Line: 525,
						...
						Src:  "m[\"s\"].Text == m[\"slicing\"].Text",
						Args: []ir.FilterExpr{
							{Line: 525, Op: ir.FilterVarTextOp, Src: "m[\"s\"].Text", Value: "s"},
							{Line: 525, Op: ir.FilterVarTextOp, Src: "m[\"slicing\"].Text", Value: "slicing"},
						},
					},
					LocationVar: "slicing",
				},
				{
					...
					SyntaxPatterns: []ir.PatternString{
						...
						{Line: 531, Value: "$s[:strings.Index($s, $_)]"},
						{Line: 532, Value: "$s[bytes.Index($s, $_):]"},
						{Line: 533, Value: "$s[:bytes.Index($s, $_)]"},
					},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line:            542,
				SyntaxPatterns:  []ir.PatternString{{Line: 542, Value: "$s[:]"}},
					...
					Args: []ir.FilterExpr{
						{
							...
							Src:   "m[\"s\"].Type.Is(`string`)",
							Value: "s",
							Args:  []ir.FilterExpr{{Line: 543, Op: ir.FilterStringOp, Src: "`string`", Value: "string"}},
						},
						{
							Line:  543,
							Op:    ir.FilterVarTypeIsOp,
							Src:   "m[\"s\"].Type.Is(`[]$_`)",
							Value: "s",
							Args:  []ir.FilterExpr{{Line: 543, Op: ir.FilterStringOp, Src: "`[]$_`", Value: "[]$_"}},
						},
					},
				},
			}},
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:           553,
					SyntaxPatterns: []ir.PatternString{{Line: 553, Value: "$constval != $x"}},
				...
				{
					Line:           558,
					SyntaxPatterns: []ir.PatternString{{Line: 558, Value: "nil != $x"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Args: []ir.FilterExpr{{
							...
							Src:   "m[\"x\"].Node.Is(`BasicLit`)",
							Value: "x",
							Args:  []ir.FilterExpr{{Line: 558, Op: ir.FilterStringOp, Src: "`BasicLit`", Value: "BasicLit"}},
						}},
					},
				},
				{
		...
		},
		{
			...
			Rules: []ir.Rule{
				...
				},
				{
					Line: 589,
					SyntaxPatterns: []ir.PatternString{
						{Line: 590, Value: "strings.ToLower($x) != $y"},
						{Line: 591, Value: "strings.ToLower($x) != strings.ToLower($y)"},
						{Line: 592, Value: "$x != strings.ToLower($y)"},
						{Line: 593, Value: "strings.ToUpper($x) != $y"},
						{Line: 594, Value: "strings.ToUpper($x) != strings.ToUpper($y)"},
						{Line: 595, Value: "$x != strings.ToUpper($y)"},
					},
					ReportTemplate:  "consider replacing with !strings.EqualFold($x, $y)",
					SuggestTemplate: "!strings.EqualFold($x, $y)",
					WhereExpr: ir.FilterExpr{
				...
				},
				{
					Line: 601,
					SyntaxPatterns: []ir.PatternString{
						{Line: 602, Value: "bytes.Equal(bytes.ToLower($x), $y)"},
						{Line: 603, Value: "bytes.Equal(bytes.ToLower($x), bytes.ToLower($y))"},
						{Line: 604, Value: "bytes.Equal($x, bytes.ToLower($y))"},
						{Line: 605, Value: "bytes.Equal(bytes.ToUpper($x), $y)"},
						{Line: 606, Value: "bytes.Equal(bytes.ToUpper($x), bytes.ToUpper($y))"},
						{Line: 607, Value: "bytes.Equal($x, bytes.ToUpper($y))"},
					},
						...
						Args: []ir.FilterExpr{
							{
								...
								Src:  "m[\"x\"].Pure && m[\"y\"].Pure",
								Args: []ir.FilterExpr{
									{Line: 608, Op: ir.FilterVarPureOp, Src: "m[\"x\"].Pure", Value: "x"},
									{Line: 608, Op: ir.FilterVarPureOp, Src: "m[\"y\"].Pure", Value: "y"},
								},
							},
							{
								Line: 608,
								...
								Src:  "m[\"x\"].Text != m[\"y\"].Text",
								Args: []ir.FilterExpr{
									{Line: 608, Op: ir.FilterVarTextOp, Src: "m[\"x\"].Text", Value: "x"},
									{Line: 608, Op: ir.FilterVarTextOp, Src: "m[\"y\"].Text", Value: "y"},
								},
							},
						},
					},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line: 618,
				SyntaxPatterns: []ir.PatternString{
					{Line: 619, Value: "strings.HasPrefix($lit, $s)"},
					{Line: 620, Value: "bytes.HasPrefix($lit, $s)"},
					{Line: 621, Value: "strings.HasSuffix($lit, $s)"},
					{Line: 622, Value: "bytes.HasSuffix($lit, $s)"},
					{Line: 623, Value: "strings.Contains($lit, $s)"},
					{Line: 624, Value: "bytes.Contains($lit, $s)"},
					{Line: 625, Value: "strings.TrimPrefix($lit, $s)"},
					{Line: 626, Value: "bytes.TrimPrefix($lit, $s)"},
					{Line: 627, Value: "strings.TrimSuffix($lit, $s)"},
					{Line: 628, Value: "bytes.TrimSuffix($lit, $s)"},
					{Line: 629, Value: "strings.Split($lit, $s)"},
					{Line: 630, Value: "bytes.Split($lit, $s)"},
				},
					...
					Args: []ir.FilterExpr{
						...
						},
						{
							...
							Args: []ir.FilterExpr{{
								...
								Src:   "m[\"lit\"].Node.Is(`Ident`)",
								Value: "lit",
								Args:  []ir.FilterExpr{{Line: 633, Op: ir.FilterStringOp, Src: "`Ident`", Value: "Ident"}},
							}},
						},
					},
				},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            642,
					SyntaxPatterns:  []ir.PatternString{{Line: 642, Value: "strings.Join([]string{$x, $y}, \"\")"}},
					ReportTemplate:  "suggestion: $x + $y",
					SuggestTemplate: "$x + $y",
				},
				{
					Line:            643,
					SyntaxPatterns:  []ir.PatternString{{Line: 643, Value: "strings.Join([]string{$x, $y, $z}, \"\")"}},
					ReportTemplate:  "suggestion: $x + $y + $z",
					SuggestTemplate: "$x + $y + $z",
				},
				{
					Line:            644,
					SyntaxPatterns:  []ir.PatternString{{Line: 644, Value: "strings.Join([]string{$x, $y}, $glue)"}},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            656,
					SyntaxPatterns:  []ir.PatternString{{Line: 656, Value: "$t.Unix() / 1000"}},
								...
								Args: []ir.FilterExpr{
									{
										...
										Value: "t",
										Args:  []ir.FilterExpr{{Line: 653, Op: ir.FilterStringOp, Src: "`time.Time`", Value: "time.Time"}},
									},
									{
										Line:  657,
										Op:    ir.FilterVarTypeIsOp,
				...
				{
					Line:            661,
					SyntaxPatterns:  []ir.PatternString{{Line: 661, Value: "$t.UnixNano() * 1000"}},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            676,
					SyntaxPatterns:  []ir.PatternString{{Line: 676, Value: "!$t.Before($tt)"}},
						...
						Args: []ir.FilterExpr{
							{
								...
								Src:   "m[\"t\"].Type.Is(`time.Time`)",
								Value: "t",
								Args:  []ir.FilterExpr{{Line: 673, Op: ir.FilterStringOp, Src: "`time.Time`", Value: "time.Time"}},
							},
							{
								Line:  677,
								Op:    ir.FilterVarTypeIsOp,
				...
				{
					Line:            680,
					SyntaxPatterns:  []ir.PatternString{{Line: 680, Value: "!$t.After($tt)"}},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:           694,
					SyntaxPatterns: []ir.PatternString{{Line: 694, Value: "type $x struct { $*_; sync.Mutex; $*_ }"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "isExported(m[\"x\"])",
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 691, Op: ir.FilterStringOp, Src: "`^\\p{Lu}`", Value: "^\\p{Lu}"}},
					},
				},
				{
					Line:           698,
					SyntaxPatterns: []ir.PatternString{{Line: 698, Value: "type $x struct { $*_; *sync.Mutex; $*_ }"}},
					ReportTemplate: "don't embed *sync.Mutex",
					WhereExpr: ir.FilterExpr{
						Line:  699,
						Op:    ir.FilterVarTextMatchesOp,
				...
				{
					Line:           702,
					SyntaxPatterns: []ir.PatternString{{Line: 702, Value: "type $x struct { $*_; sync.RWMutex; $*_ }"}},
				...
				{
					Line:           706,
					SyntaxPatterns: []ir.PatternString{{Line: 706, Value: "type $x struct { $*_; *sync.RWMutex; $*_ }"}},
					ReportTemplate: "don't embed *sync.RWMutex",
					WhereExpr: ir.FilterExpr{
						Line:  707,
						Op:    ir.FilterVarTextMatchesOp,
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            716,
					SyntaxPatterns:  []ir.PatternString{{Line: 716, Value: "$x = sort.IntSlice($x)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "m[\"x\"].Type.Is(`[]int`)",
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 717, Op: ir.FilterStringOp, Src: "`[]int`", Value: "[]int"}},
					},
				},
				{
					Line:            721,
					SyntaxPatterns:  []ir.PatternString{{Line: 721, Value: "$x = sort.Float64Slice($x)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 722, Op: ir.FilterStringOp, Src: "`[]float64`", Value: "[]float64"}},
					},
				},
				{
					Line:            726,
					SyntaxPatterns:  []ir.PatternString{{Line: 726, Value: "$x = sort.StringSlice($x)"}},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line:           737,
				SyntaxPatterns: []ir.PatternString{{Line: 737, Value: "$pkg.$err = $x"}},
					...
					Args: []ir.FilterExpr{
						{
							...
							Value: "err",
							Args:  []ir.FilterExpr{{Line: 738, Op: ir.FilterStringOp, Src: "`error`", Value: "error"}},
						},
						{
							Line:  738,
							Op:    ir.FilterVarObjectIsOp,
							Src:   "m[\"pkg\"].Object.Is(`PkgName`)",
							Value: "pkg",
							Args:  []ir.FilterExpr{{Line: 738, Op: ir.FilterStringOp, Src: "`PkgName`", Value: "PkgName"}},
						},
					},
				},
			}},
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:           747,
					SyntaxPatterns: []ir.PatternString{{Line: 747, Value: "var()"}},
					ReportTemplate: "empty var() block",
				},
				{
					Line:           748,
					SyntaxPatterns: []ir.PatternString{{Line: 748, Value: "const()"}},
					ReportTemplate: "empty const() block",
				},
				{
					Line:           749,
					SyntaxPatterns: []ir.PatternString{{Line: 749, Value: "type()"}},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            757,
					SyntaxPatterns:  []ir.PatternString{{Line: 757, Value: "fmt.Errorf($f)"}},
				...
				{
					Line:            762,
					SyntaxPatterns:  []ir.PatternString{{Line: 762, Value: "fmt.Errorf($f($*args))"}},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            772,
					SyntaxPatterns:  []ir.PatternString{{Line: 772, Value: "strings.Compare($s1, $s2) == 0"}},
				...
				},
				{
					Line: 775,
					SyntaxPatterns: []ir.PatternString{
						{Line: 775, Value: "strings.Compare($s1, $s2) == -1"},
						{Line: 776, Value: "strings.Compare($s1, $s2) < 0"},
					},
					ReportTemplate:  "suggestion: $s1 < $s2",
					SuggestTemplate: "$s1 < $s2",
				},
				{
					Line: 779,
					SyntaxPatterns: []ir.PatternString{
						{Line: 779, Value: "strings.Compare($s1, $s2) == 1"},
						{Line: 780, Value: "strings.Compare($s1, $s2) > 0"},
					},
					ReportTemplate:  "suggestion: $s1 > $s2",
					SuggestTemplate: "$s1 > $s2",
				},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line: 789,
				SyntaxPatterns: []ir.PatternString{
					{Line: 790, Value: "if $err := $_($*_); $err2 != nil { $*_ }"},
					{Line: 791, Value: "if $err = $_($*_); $err2 != nil { $*_ }"},
					{Line: 792, Value: "if $*_, $err := $_($*_); $err2 != nil { $*_ }"},
					{Line: 793, Value: "if $*_, $err = $_($*_); $err2 != nil { $*_ }"},
				},
				...
				WhereExpr: ir.FilterExpr{
					...
					Args: []ir.FilterExpr{
							...
							Args: []ir.FilterExpr{
								{
									...
									Value: "err",
									Args:  []ir.FilterExpr{{Line: 794, Op: ir.FilterStringOp, Src: "\"error\"", Value: "error"}},
								},
								{
									Line:  794,
									Op:    ir.FilterVarTypeImplementsOp,
						...
						},
						{
							...
							Args: []ir.FilterExpr{
								{Line: 795, Op: ir.FilterVarTextOp, Src: "m[\"err\"].Text", Value: "err"},
								{Line: 795, Op: ir.FilterVarTextOp, Src: "m[\"err2\"].Text", Value: "err2"},
							},
						},
					},
				},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:           805,
					SyntaxPatterns: []ir.PatternString{{Line: 805, Value: "$*_; sync.OnceFunc($x); $*_;"}},
				...
				{
					Line:           809,
					SyntaxPatterns: []ir.PatternString{{Line: 809, Value: "sync.OnceFunc($x)()"}},
