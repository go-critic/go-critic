...
var PrecompiledRules = &ir.File{
	...
	RuleGroups: []ir.RuleGroup{
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line:            428,
				SyntaxPatterns:  []ir.PatternString{{Line: 428, Value: "$x + string(os.PathSeparator) + $y"}},
					...
					Args: []ir.FilterExpr{
						{
							...
							Src:   "m[\"x\"].Type.Is(`string`)",
							Value: "x",
							Args:  []ir.FilterExpr{{Line: 429, Op: ir.FilterStringOp, Src: "`string`", Value: "string"}},
						},
						{
							Line:  429,
							Op:    ir.FilterVarTypeIsOp,
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            439,
					SyntaxPatterns:  []ir.PatternString{{Line: 439, Value: "$w.Write([]byte($s))"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "m[\"w\"].Type.Implements(\"io.StringWriter\")",
						Value: "w",
						Args:  []ir.FilterExpr{{Line: 440, Op: ir.FilterStringOp, Src: "\"io.StringWriter\"", Value: "io.StringWriter"}},
					},
				},
				{
					Line:            444,
					SyntaxPatterns:  []ir.PatternString{{Line: 444, Value: "io.WriteString($w, $s)"}},
					ReportTemplate:  "$w.WriteString($s) should be preferred to the $$",
					SuggestTemplate: "$w.WriteString($s)",
					WhereExpr: ir.FilterExpr{
						Line:  445,
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line:           455,
				SyntaxPatterns: []ir.PatternString{{Line: 455, Value: "for $i := 0; $i < len($xs); $i++ { $xs[$i] = $zero }"}},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line:           465,
				SyntaxPatterns: []ir.PatternString{{Line: 465, Value: "$_, $ok := $m.Load($k); if $ok { $m.Delete($k); $*_ }"}},
				...
				WhereExpr: ir.FilterExpr{
					...
					Args: []ir.FilterExpr{
						...
						},
						{
							...
							Value: "m",
							Args:  []ir.FilterExpr{{Line: 467, Op: ir.FilterStringOp, Src: "`*sync.Map`", Value: "*sync.Map"}},
						},
					},
				},
			}},
		},
		{
			...
			Rules: []ir.Rule{{
				Line:           476,
				SyntaxPatterns: []ir.PatternString{{Line: 476, Value: "fmt.Sprintf($s, $*_)"}},
				...
				WhereExpr: ir.FilterExpr{
					...
					Args: []ir.FilterExpr{
						...
						},
						{
							...
							Src:   "m[\"s\"].Text.Matches(`^\".*\\\\\"%s\\\\\".*\"$`)",
							Value: "s",
							Args:  []ir.FilterExpr{{Line: 478, Op: ir.FilterStringOp, Src: "`^\".*\\\\\"%s\\\\\".*\"$`", Value: "^\".*\\\\\"%s\\\\\".*\"$"}},
						},
					},
				},
			}},
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            487,
					SyntaxPatterns:  []ir.PatternString{{Line: 487, Value: "$x[len($x)]"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Args: []ir.FilterExpr{
							{Line: 488, Op: ir.FilterVarPureOp, Src: "m[\"x\"].Pure", Value: "x"},
							{
								...
								Src:   "m[\"x\"].Type.Is(`[]$_`)",
								Value: "x",
								Args:  []ir.FilterExpr{{Line: 488, Op: ir.FilterStringOp, Src: "`[]$_`", Value: "[]$_"}},
							},
						},
					},
				},
				{
					...
					SyntaxPatterns: []ir.PatternString{
						...
						{Line: 497, Value: "$i := strings.Index($s, $_); $_ = $slicing[$i:]"},
						{Line: 498, Value: "$i := bytes.Index($s, $_); $_ := $slicing[$i:]"},
						{Line: 499, Value: "$i := bytes.Index($s, $_); $_ = $slicing[$i:]"},
					},
					...
					WhereExpr: ir.FilterExpr{
						...
						Args: []ir.FilterExpr{
							{Line: 500, Op: ir.FilterVarTextOp, Src: "m[\"s\"].Text", Value: "s"},
							{Line: 500, Op: ir.FilterVarTextOp, Src: "m[\"slicing\"].Text", Value: "slicing"},
						},
					},
					LocationVar: "slicing",
				},
				...
				},
				{
					...
					SyntaxPatterns: []ir.PatternString{
						...
						{Line: 515, Value: "$s[:strings.Index($s, $_)]"},
						{Line: 516, Value: "$s[bytes.Index($s, $_):]"},
						{Line: 517, Value: "$s[:bytes.Index($s, $_)]"},
					},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line:            526,
				SyntaxPatterns:  []ir.PatternString{{Line: 526, Value: "$s[:]"}},
					...
					Args: []ir.FilterExpr{
						{
							...
							Src:   "m[\"s\"].Type.Is(`string`)",
							Value: "s",
							Args:  []ir.FilterExpr{{Line: 527, Op: ir.FilterStringOp, Src: "`string`", Value: "string"}},
						},
						{
							Line:  527,
							Op:    ir.FilterVarTypeIsOp,
							Src:   "m[\"s\"].Type.Is(`[]$_`)",
							Value: "s",
							Args:  []ir.FilterExpr{{Line: 527, Op: ir.FilterStringOp, Src: "`[]$_`", Value: "[]$_"}},
						},
					},
				},
			}},
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:           537,
					SyntaxPatterns: []ir.PatternString{{Line: 537, Value: "$constval != $x"}},
						...
						Args: []ir.FilterExpr{
							{
								...
								Value: "constval",
								Args:  []ir.FilterExpr{{Line: 537, Op: ir.FilterStringOp, Src: "`BasicLit`", Value: "BasicLit"}},
							},
							{
								Line: 537,
								Op:   ir.FilterNotOp,
				...
				{
					Line:           539,
					SyntaxPatterns: []ir.PatternString{{Line: 539, Value: "$constval == $x"}},
					ReportTemplate: "consider to change order in expression to $x == $constval",
					WhereExpr: ir.FilterExpr{
						Line: 539,
						Op:   ir.FilterAndOp,
						...
						Args: []ir.FilterExpr{
							{
								...
								Src:   "m[\"constval\"].Node.Is(`BasicLit`)",
								Value: "constval",
								Args:  []ir.FilterExpr{{Line: 539, Op: ir.FilterStringOp, Src: "`BasicLit`", Value: "BasicLit"}},
							},
							{
								Line: 539,
								Op:   ir.FilterNotOp,
				...
				{
					Line:           542,
					SyntaxPatterns: []ir.PatternString{{Line: 542, Value: "nil != $x"}},
				...
				{
					Line:           544,
					SyntaxPatterns: []ir.PatternString{{Line: 544, Value: "nil == $x"}},
					ReportTemplate: "consider to change order in expression to $x == nil",
					WhereExpr: ir.FilterExpr{
						Line: 544,
						Op:   ir.FilterNotOp,
			...
			Rules: []ir.Rule{
				{
					Line: 561,
					SyntaxPatterns: []ir.PatternString{
						{Line: 562, Value: "strings.ToLower($x) == $y"},
						{Line: 563, Value: "strings.ToLower($x) == strings.ToLower($y)"},
						{Line: 564, Value: "$x == strings.ToLower($y)"},
						{Line: 565, Value: "strings.ToUpper($x) == $y"},
						{Line: 566, Value: "strings.ToUpper($x) == strings.ToUpper($y)"},
						{Line: 567, Value: "$x == strings.ToUpper($y)"},
					},
						...
						Args: []ir.FilterExpr{
							{
								...
								Src:  "m[\"x\"].Pure && m[\"y\"].Pure",
								Args: []ir.FilterExpr{
									{Line: 568, Op: ir.FilterVarPureOp, Src: "m[\"x\"].Pure", Value: "x"},
									{Line: 568, Op: ir.FilterVarPureOp, Src: "m[\"y\"].Pure", Value: "y"},
								},
							},
							{
								Line: 568,
								...
								Args: []ir.FilterExpr{
									{Line: 568, Op: ir.FilterVarTextOp, Src: "m[\"x\"].Text", Value: "x"},
									{Line: 568, Op: ir.FilterVarTextOp, Src: "m[\"y\"].Text", Value: "y"},
								},
							},
						},
					},
				},
				{
					Line: 573,
					SyntaxPatterns: []ir.PatternString{
						{Line: 574, Value: "strings.ToLower($x) != $y"},
						{Line: 575, Value: "strings.ToLower($x) != strings.ToLower($y)"},
						{Line: 576, Value: "$x != strings.ToLower($y)"},
						{Line: 577, Value: "strings.ToUpper($x) != $y"},
						{Line: 578, Value: "strings.ToUpper($x) != strings.ToUpper($y)"},
						{Line: 579, Value: "$x != strings.ToUpper($y)"},
					},
					ReportTemplate:  "consider replacing with !strings.EqualFold($x, $y)",
					SuggestTemplate: "!strings.EqualFold($x, $y)",
					WhereExpr: ir.FilterExpr{
						...
						Args: []ir.FilterExpr{
							{
								...
								Src:  "m[\"x\"].Pure && m[\"y\"].Pure",
								Args: []ir.FilterExpr{
									{Line: 580, Op: ir.FilterVarPureOp, Src: "m[\"x\"].Pure", Value: "x"},
									{Line: 580, Op: ir.FilterVarPureOp, Src: "m[\"y\"].Pure", Value: "y"},
								},
							},
							{
								Line: 580,
								...
								Src:  "m[\"x\"].Text != m[\"y\"].Text",
								Args: []ir.FilterExpr{
									{Line: 580, Op: ir.FilterVarTextOp, Src: "m[\"x\"].Text", Value: "x"},
									{Line: 580, Op: ir.FilterVarTextOp, Src: "m[\"y\"].Text", Value: "y"},
								},
							},
						},
					},
				},
				{
					Line: 585,
					SyntaxPatterns: []ir.PatternString{
						{Line: 586, Value: "bytes.Equal(bytes.ToLower($x), $y)"},
						{Line: 587, Value: "bytes.Equal(bytes.ToLower($x), bytes.ToLower($y))"},
						{Line: 588, Value: "bytes.Equal($x, bytes.ToLower($y))"},
						{Line: 589, Value: "bytes.Equal(bytes.ToUpper($x), $y)"},
						{Line: 590, Value: "bytes.Equal(bytes.ToUpper($x), bytes.ToUpper($y))"},
						{Line: 591, Value: "bytes.Equal($x, bytes.ToUpper($y))"},
					},
						...
						Args: []ir.FilterExpr{
							{
								...
								Src:  "m[\"x\"].Pure && m[\"y\"].Pure",
								Args: []ir.FilterExpr{
									{Line: 592, Op: ir.FilterVarPureOp, Src: "m[\"x\"].Pure", Value: "x"},
									{Line: 592, Op: ir.FilterVarPureOp, Src: "m[\"y\"].Pure", Value: "y"},
								},
							},
							{
								Line: 592,
								...
								Src:  "m[\"x\"].Text != m[\"y\"].Text",
								Args: []ir.FilterExpr{
									{Line: 592, Op: ir.FilterVarTextOp, Src: "m[\"x\"].Text", Value: "x"},
									{Line: 592, Op: ir.FilterVarTextOp, Src: "m[\"y\"].Text", Value: "y"},
								},
							},
						},
					},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line: 602,
				SyntaxPatterns: []ir.PatternString{
					{Line: 603, Value: "strings.HasPrefix($lit, $s)"},
					{Line: 604, Value: "bytes.HasPrefix($lit, $s)"},
					{Line: 605, Value: "strings.HasSuffix($lit, $s)"},
					{Line: 606, Value: "bytes.HasSuffix($lit, $s)"},
					{Line: 607, Value: "strings.Contains($lit, $s)"},
					{Line: 608, Value: "bytes.Contains($lit, $s)"},
					{Line: 609, Value: "strings.TrimPrefix($lit, $s)"},
					{Line: 610, Value: "bytes.TrimPrefix($lit, $s)"},
					{Line: 611, Value: "strings.TrimSuffix($lit, $s)"},
					{Line: 612, Value: "bytes.TrimSuffix($lit, $s)"},
					{Line: 613, Value: "strings.Split($lit, $s)"},
					{Line: 614, Value: "bytes.Split($lit, $s)"},
				},
					...
					Args: []ir.FilterExpr{
						...
						},
						{
							...
							Args: []ir.FilterExpr{{
								...
								Src:   "m[\"lit\"].Node.Is(`Ident`)",
								Value: "lit",
								Args:  []ir.FilterExpr{{Line: 617, Op: ir.FilterStringOp, Src: "`Ident`", Value: "Ident"}},
							}},
						},
					},
				},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            626,
					SyntaxPatterns:  []ir.PatternString{{Line: 626, Value: "strings.Join([]string{$x, $y}, \"\")"}},
					ReportTemplate:  "suggestion: $x + $y",
					SuggestTemplate: "$x + $y",
				},
				{
					Line:            627,
					SyntaxPatterns:  []ir.PatternString{{Line: 627, Value: "strings.Join([]string{$x, $y, $z}, \"\")"}},
					ReportTemplate:  "suggestion: $x + $y + $z",
					SuggestTemplate: "$x + $y + $z",
				},
				{
					Line:            628,
					SyntaxPatterns:  []ir.PatternString{{Line: 628, Value: "strings.Join([]string{$x, $y}, $glue)"}},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            640,
					SyntaxPatterns:  []ir.PatternString{{Line: 640, Value: "$t.Unix() / 1000"}},
								...
								Args: []ir.FilterExpr{
									{
										...
										Value: "t",
										Args:  []ir.FilterExpr{{Line: 637, Op: ir.FilterStringOp, Src: "`time.Time`", Value: "time.Time"}},
									},
									{
										Line:  641,
										Op:    ir.FilterVarTypeIsOp,
				...
				{
					Line:            645,
					SyntaxPatterns:  []ir.PatternString{{Line: 645, Value: "$t.UnixNano() * 1000"}},
			...
			Rules: []ir.Rule{
				{
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "isExported(m[\"x\"])",
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 657, Op: ir.FilterStringOp, Src: "`^\\p{Lu}`", Value: "^\\p{Lu}"}},
					},
				},
				{
					Line:           664,
					SyntaxPatterns: []ir.PatternString{{Line: 664, Value: "type $x struct { $*_; *sync.Mutex; $*_ }"}},
					ReportTemplate: "don't embed *sync.Mutex",
					WhereExpr: ir.FilterExpr{
						Line:  665,
						Op:    ir.FilterVarTextMatchesOp,
				...
				{
					Line:           672,
					SyntaxPatterns: []ir.PatternString{{Line: 672, Value: "type $x struct { $*_; *sync.RWMutex; $*_ }"}},
					ReportTemplate: "don't embed *sync.RWMutex",
					WhereExpr: ir.FilterExpr{
						Line:  673,
						Op:    ir.FilterVarTextMatchesOp,
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            682,
					SyntaxPatterns:  []ir.PatternString{{Line: 682, Value: "$x = sort.IntSlice($x)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "m[\"x\"].Type.Is(`[]int`)",
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 683, Op: ir.FilterStringOp, Src: "`[]int`", Value: "[]int"}},
					},
				},
				{
					Line:            687,
					SyntaxPatterns:  []ir.PatternString{{Line: 687, Value: "$x = sort.Float64Slice($x)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 688, Op: ir.FilterStringOp, Src: "`[]float64`", Value: "[]float64"}},
					},
				},
				{
					Line:            692,
					SyntaxPatterns:  []ir.PatternString{{Line: 692, Value: "$x = sort.StringSlice($x)"}},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line:           703,
				SyntaxPatterns: []ir.PatternString{{Line: 703, Value: "$pkg.$err = $x"}},
					...
					Args: []ir.FilterExpr{
						{
							...
							Value: "err",
							Args:  []ir.FilterExpr{{Line: 704, Op: ir.FilterStringOp, Src: "`error`", Value: "error"}},
						},
						{
							Line:  704,
							Op:    ir.FilterVarObjectIsOp,
							Src:   "m[\"pkg\"].Object.Is(`PkgName`)",
							Value: "pkg",
							Args:  []ir.FilterExpr{{Line: 704, Op: ir.FilterStringOp, Src: "`PkgName`", Value: "PkgName"}},
						},
					},
				},
			}},
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:           713,
					SyntaxPatterns: []ir.PatternString{{Line: 713, Value: "var()"}},
					ReportTemplate: "empty var() block",
				},
				{
					Line:           714,
					SyntaxPatterns: []ir.PatternString{{Line: 714, Value: "const()"}},
					ReportTemplate: "empty const() block",
				},
				{
					Line:           715,
					SyntaxPatterns: []ir.PatternString{{Line: 715, Value: "type()"}},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            723,
					SyntaxPatterns:  []ir.PatternString{{Line: 723, Value: "fmt.Errorf($f)"}},
				...
				{
					Line:            728,
					SyntaxPatterns:  []ir.PatternString{{Line: 728, Value: "fmt.Errorf($f($*args))"}},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            738,
					SyntaxPatterns:  []ir.PatternString{{Line: 738, Value: "strings.Compare($s1, $s2) == 0"}},
				...
				},
				{
					Line: 745,
					SyntaxPatterns: []ir.PatternString{
						{Line: 745, Value: "strings.Compare($s1, $s2) == 1"},
						{Line: 746, Value: "strings.Compare($s1, $s2) > 0"},
					},
					ReportTemplate:  "suggestion: $s1 > $s2",
					SuggestTemplate: "$s1 > $s2",
				},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line: 755,
				SyntaxPatterns: []ir.PatternString{
					{Line: 756, Value: "if $err := $_($*_); $err2 != nil { $*_ }"},
					{Line: 757, Value: "if $err = $_($*_); $err2 != nil { $*_ }"},
					{Line: 758, Value: "if $*_, $err := $_($*_); $err2 != nil { $*_ }"},
					{Line: 759, Value: "if $*_, $err = $_($*_); $err2 != nil { $*_ }"},
				},
				...
				WhereExpr: ir.FilterExpr{
					...
					Args: []ir.FilterExpr{
							...
							Args: []ir.FilterExpr{
								{
									...
									Value: "err",
									Args:  []ir.FilterExpr{{Line: 760, Op: ir.FilterStringOp, Src: "\"error\"", Value: "error"}},
								},
								{
									Line:  760,
									Op:    ir.FilterVarTypeImplementsOp,
						...
						},
						{
							...
							Args: []ir.FilterExpr{
								{Line: 761, Op: ir.FilterVarTextOp, Src: "m[\"err\"].Text", Value: "err"},
								{Line: 761, Op: ir.FilterVarTextOp, Src: "m[\"err2\"].Text", Value: "err2"},
							},
						},
					},
				},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:           771,
					SyntaxPatterns: []ir.PatternString{{Line: 771, Value: "$*_; sync.OnceFunc($x); $*_;"}},
				...
				{
					Line:           775,
					SyntaxPatterns: []ir.PatternString{{Line: 775, Value: "sync.OnceFunc($x)()"}},
