	...
	RuleGroups: []ir.RuleGroup{
		...
		},
		{
			...
			Rules: []ir.Rule{
				...
				{
					Line:            375,
					SyntaxPatterns:  []ir.PatternString{{Line: 375, Value: "$w.WriteString(fmt.Sprint($*args))"}},
					ReportTemplate:  "suggestion: fmt.Fprint($w, $args)",
					SuggestTemplate: "fmt.Fprint($w, $args)",
					WhereExpr: ir.FilterExpr{
						Line: 376,
						...
						Args: []ir.FilterExpr{
							{
								...
								Src:   "m[\"w\"].Type.Implements(\"io.Writer\")",
								Value: "w",
								Args:  []ir.FilterExpr{{Line: 376, Op: ir.FilterStringOp, Src: "\"io.Writer\"", Value: "io.Writer"}},
							},
							{
								Line:  376,
								Op:    ir.FilterVarTypeImplementsOp,
								...
								Value: "w",
								Args:  []ir.FilterExpr{{Line: 376, Op: ir.FilterStringOp, Src: "\"io.StringWriter\"", Value: "io.StringWriter"}},
							},
						},
					},
				},
				{
					Line:            378,
					SyntaxPatterns:  []ir.PatternString{{Line: 378, Value: "$w.WriteString(fmt.Sprintf($*args))"}},
					ReportTemplate:  "suggestion: fmt.Fprintf($w, $args)",
					SuggestTemplate: "fmt.Fprintf($w, $args)",
					WhereExpr: ir.FilterExpr{
						Line: 379,
						...
						Args: []ir.FilterExpr{
							{
								...
								Src:   "m[\"w\"].Type.Implements(\"io.Writer\")",
								Value: "w",
								Args:  []ir.FilterExpr{{Line: 379, Op: ir.FilterStringOp, Src: "\"io.Writer\"", Value: "io.Writer"}},
							},
							{
								Line:  379,
								Op:    ir.FilterVarTypeImplementsOp,
								Src:   "m[\"w\"].Type.Implements(\"io.StringWriter\")",
								Value: "w",
								Args:  []ir.FilterExpr{{Line: 379, Op: ir.FilterStringOp, Src: "\"io.StringWriter\"", Value: "io.StringWriter"}},
							},
						},
					},
				},
				{
					Line:            381,
					SyntaxPatterns:  []ir.PatternString{{Line: 381, Value: "$w.WriteString(fmt.Sprintln($*args))"}},
					ReportTemplate:  "suggestion: fmt.Fprintln($w, $args)",
					SuggestTemplate: "fmt.Fprintln($w, $args)",
					WhereExpr: ir.FilterExpr{
						Line: 382,
						...
						Args: []ir.FilterExpr{
							{
								...
								Src:   "m[\"w\"].Type.Implements(\"io.Writer\")",
								Value: "w",
								Args:  []ir.FilterExpr{{Line: 382, Op: ir.FilterStringOp, Src: "\"io.Writer\"", Value: "io.Writer"}},
							},
							{
								Line:  382,
								Op:    ir.FilterVarTypeImplementsOp,
								Src:   "m[\"w\"].Type.Implements(\"io.StringWriter\")",
								Value: "w",
								Args:  []ir.FilterExpr{{Line: 382, Op: ir.FilterStringOp, Src: "\"io.StringWriter\"", Value: "io.StringWriter"}},
							},
						},
					},
				},
			...
			Rules: []ir.Rule{
				{
					Line: 391,
					SyntaxPatterns: []ir.PatternString{
						{Line: 391, Value: "$x.Equal($x)"},
						{Line: 391, Value: "$x.Equals($x)"},
						{Line: 391, Value: "$x.Compare($x)"},
						{Line: 391, Value: "$x.Cmp($x)"},
					},
					ReportTemplate: "suspicious method call with the same argument and receiver",
					WhereExpr:      ir.FilterExpr{Line: 392, Op: ir.FilterVarPureOp, Src: "m[\"x\"].Pure", Value: "x"},
				},
				{
					Line: 395,
					SyntaxPatterns: []ir.PatternString{
						{Line: 395, Value: "copy($x, $x)"},
						{Line: 396, Value: "math.Max($x, $x)"},
						{Line: 397, Value: "math.Min($x, $x)"},
						{Line: 398, Value: "reflect.Copy($x, $x)"},
						{Line: 399, Value: "reflect.DeepEqual($x, $x)"},
						{Line: 400, Value: "strings.Contains($x, $x)"},
						{Line: 401, Value: "strings.Compare($x, $x)"},
						{Line: 402, Value: "strings.EqualFold($x, $x)"},
						{Line: 403, Value: "strings.HasPrefix($x, $x)"},
						{Line: 404, Value: "strings.HasSuffix($x, $x)"},
						{Line: 405, Value: "strings.Index($x, $x)"},
						{Line: 406, Value: "strings.LastIndex($x, $x)"},
						{Line: 407, Value: "strings.Split($x, $x)"},
						{Line: 408, Value: "strings.SplitAfter($x, $x)"},
						{Line: 409, Value: "strings.SplitAfterN($x, $x, $_)"},
						{Line: 410, Value: "strings.SplitN($x, $x, $_)"},
						{Line: 411, Value: "strings.Replace($_, $x, $x, $_)"},
						{Line: 412, Value: "strings.ReplaceAll($_, $x, $x)"},
						{Line: 413, Value: "bytes.Contains($x, $x)"},
						{Line: 414, Value: "bytes.Compare($x, $x)"},
						{Line: 415, Value: "bytes.Equal($x, $x)"},
						{Line: 416, Value: "bytes.EqualFold($x, $x)"},
						{Line: 417, Value: "bytes.HasPrefix($x, $x)"},
						{Line: 418, Value: "bytes.HasSuffix($x, $x)"},
						{Line: 419, Value: "bytes.Index($x, $x)"},
						{Line: 420, Value: "bytes.LastIndex($x, $x)"},
						{Line: 421, Value: "bytes.Split($x, $x)"},
						{Line: 422, Value: "bytes.SplitAfter($x, $x)"},
						{Line: 423, Value: "bytes.SplitAfterN($x, $x, $_)"},
						{Line: 424, Value: "bytes.SplitN($x, $x, $_)"},
						{Line: 425, Value: "bytes.Replace($_, $x, $x, $_)"},
						{Line: 426, Value: "bytes.ReplaceAll($_, $x, $x)"},
						{Line: 427, Value: "types.Identical($x, $x)"},
						{Line: 428, Value: "types.IdenticalIgnoreTags($x, $x)"},
						{Line: 429, Value: "draw.Draw($x, $_, $x, $_, $_)"},
					},
					ReportTemplate: "suspicious duplicated args in $$",
					WhereExpr:      ir.FilterExpr{Line: 430, Op: ir.FilterVarPureOp, Src: "m[\"x\"].Pure", Value: "x"},
				},
			},
		},
		{
			...
			Rules: []ir.Rule{{
				Line:           439,
				SyntaxPatterns: []ir.PatternString{{Line: 439, Value: "if $_ { $*_; http.Error($w, $err, $code) }"}},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line:            449,
				SyntaxPatterns:  []ir.PatternString{{Line: 449, Value: "$x + string(os.PathSeparator) + $y"}},
					...
					Args: []ir.FilterExpr{
						{
							...
							Src:   "m[\"x\"].Type.Is(`string`)",
							Value: "x",
							Args:  []ir.FilterExpr{{Line: 450, Op: ir.FilterStringOp, Src: "`string`", Value: "string"}},
						},
						{
							Line:  450,
							Op:    ir.FilterVarTypeIsOp,
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            460,
					SyntaxPatterns:  []ir.PatternString{{Line: 460, Value: "$w.Write([]byte($s))"}},
				...
				{
					Line:            465,
					SyntaxPatterns:  []ir.PatternString{{Line: 465, Value: "io.WriteString($w, $s)"}},
					ReportTemplate:  "$w.WriteString($s) should be preferred to the $$",
					SuggestTemplate: "$w.WriteString($s)",
					WhereExpr: ir.FilterExpr{
						Line:  466,
						...
						Src:   "m[\"w\"].Type.Implements(\"io.StringWriter\")",
						Value: "w",
						Args:  []ir.FilterExpr{{Line: 466, Op: ir.FilterStringOp, Src: "\"io.StringWriter\"", Value: "io.StringWriter"}},
					},
				},
			},
		},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line:           486,
				SyntaxPatterns: []ir.PatternString{{Line: 486, Value: "$_, $ok := $m.Load($k); if $ok { $m.Delete($k); $*_ }"}},
				...
				WhereExpr: ir.FilterExpr{
					...
					Args: []ir.FilterExpr{
						...
						},
						{
							...
							Value: "m",
							Args:  []ir.FilterExpr{{Line: 488, Op: ir.FilterStringOp, Src: "`*sync.Map`", Value: "*sync.Map"}},
						},
					},
				},
			}},
		},
		{
			...
			Rules: []ir.Rule{{
				Line:           497,
				SyntaxPatterns: []ir.PatternString{{Line: 497, Value: "fmt.Sprintf($s, $*_)"}},
					...
					Args: []ir.FilterExpr{
						{
							...
							Src:   "m[\"s\"].Text.Matches(\"^`.*\\\"%s\\\".*`$\")",
							Value: "s",
							Args:  []ir.FilterExpr{{Line: 498, Op: ir.FilterStringOp, Src: "\"^`.*\\\"%s\\\".*`$\"", Value: "^`.*\"%s\".*`$"}},
						},
						{
							Line:  499,
							Op:    ir.FilterVarTextMatchesOp,
							Src:   "m[\"s\"].Text.Matches(`^\".*\\\\\"%s\\\\\".*\"$`)",
							Value: "s",
							Args:  []ir.FilterExpr{{Line: 499, Op: ir.FilterStringOp, Src: "`^\".*\\\\\"%s\\\\\".*\"$`", Value: "^\".*\\\\\"%s\\\\\".*\"$"}},
						},
					},
				},
			}},
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            508,
					SyntaxPatterns:  []ir.PatternString{{Line: 508, Value: "$x[len($x)]"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Args: []ir.FilterExpr{
							{Line: 509, Op: ir.FilterVarPureOp, Src: "m[\"x\"].Pure", Value: "x"},
							{
								Line:  509,
								Op:    ir.FilterVarTypeIsOp,
								Src:   "m[\"x\"].Type.Is(`[]$_`)",
								Value: "x",
								Args:  []ir.FilterExpr{{Line: 509, Op: ir.FilterStringOp, Src: "`[]$_`", Value: "[]$_"}},
							},
						},
					},
				},
				{
					...
					WhereExpr: ir.FilterExpr{
						...
						Args: []ir.FilterExpr{
							{Line: 521, Op: ir.FilterVarTextOp, Src: "m[\"s\"].Text", Value: "s"},
							{Line: 521, Op: ir.FilterVarTextOp, Src: "m[\"slicing\"].Text", Value: "slicing"},
						},
					},
					LocationVar: "slicing",
				},
				{
					Line: 525,
					SyntaxPatterns: []ir.PatternString{
						{Line: 526, Value: "$i := strings.Index($s, $_); $_ := $slicing[:$i]"},
						{Line: 527, Value: "$i := strings.Index($s, $_); $_ = $slicing[:$i]"},
						{Line: 528, Value: "$i := bytes.Index($s, $_); $_ := $slicing[:$i]"},
						{Line: 529, Value: "$i := bytes.Index($s, $_); $_ = $slicing[:$i]"},
					},
					ReportTemplate: "Index() can return -1; maybe you wanted to do $s[:$i+1]",
					WhereExpr: ir.FilterExpr{
						Line: 530,
						...
						Src:  "m[\"s\"].Text == m[\"slicing\"].Text",
						Args: []ir.FilterExpr{
							{Line: 530, Op: ir.FilterVarTextOp, Src: "m[\"s\"].Text", Value: "s"},
							{Line: 530, Op: ir.FilterVarTextOp, Src: "m[\"slicing\"].Text", Value: "slicing"},
						},
					},
					LocationVar: "slicing",
				},
				{
					Line: 534,
					SyntaxPatterns: []ir.PatternString{
						{Line: 535, Value: "$s[strings.Index($s, $_):]"},
						{Line: 536, Value: "$s[:strings.Index($s, $_)]"},
						{Line: 537, Value: "$s[bytes.Index($s, $_):]"},
						{Line: 538, Value: "$s[:bytes.Index($s, $_)]"},
					},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line:            547,
				SyntaxPatterns:  []ir.PatternString{{Line: 547, Value: "$s[:]"}},
				...
				WhereExpr: ir.FilterExpr{
					...
					Args: []ir.FilterExpr{
						...
						},
						{
							...
							Src:   "m[\"s\"].Type.Is(`[]$_`)",
							Value: "s",
							Args:  []ir.FilterExpr{{Line: 548, Op: ir.FilterStringOp, Src: "`[]$_`", Value: "[]$_"}},
						},
					},
				},
			}},
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:           558,
					SyntaxPatterns: []ir.PatternString{{Line: 558, Value: "$constval != $x"}},
				...
				{
					Line:           560,
					SyntaxPatterns: []ir.PatternString{{Line: 560, Value: "$constval == $x"}},
					ReportTemplate: "consider to change order in expression to $x == $constval",
					WhereExpr: ir.FilterExpr{
						Line: 560,
						Op:   ir.FilterAndOp,
				...
				{
					Line:           563,
					SyntaxPatterns: []ir.PatternString{{Line: 563, Value: "nil != $x"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Args: []ir.FilterExpr{{
							...
							Src:   "m[\"x\"].Node.Is(`BasicLit`)",
							Value: "x",
							Args:  []ir.FilterExpr{{Line: 563, Op: ir.FilterStringOp, Src: "`BasicLit`", Value: "BasicLit"}},
						}},
					},
				},
				{
					Line:           565,
					SyntaxPatterns: []ir.PatternString{{Line: 565, Value: "nil == $x"}},
					ReportTemplate: "consider to change order in expression to $x == nil",
					WhereExpr: ir.FilterExpr{
						Line: 565,
						Op:   ir.FilterNotOp,
						...
						Args: []ir.FilterExpr{{
							...
							Src:   "m[\"x\"].Node.Is(`BasicLit`)",
							Value: "x",
							Args:  []ir.FilterExpr{{Line: 565, Op: ir.FilterStringOp, Src: "`BasicLit`", Value: "BasicLit"}},
						}},
					},
				},
			},
		},
		{
			...
			Rules: []ir.Rule{
				...
				},
				{
					Line: 594,
					SyntaxPatterns: []ir.PatternString{
						{Line: 595, Value: "strings.ToLower($x) != $y"},
						{Line: 596, Value: "strings.ToLower($x) != strings.ToLower($y)"},
						{Line: 597, Value: "$x != strings.ToLower($y)"},
						{Line: 598, Value: "strings.ToUpper($x) != $y"},
						{Line: 599, Value: "strings.ToUpper($x) != strings.ToUpper($y)"},
						{Line: 600, Value: "$x != strings.ToUpper($y)"},
					},
					ReportTemplate:  "consider replacing with !strings.EqualFold($x, $y)",
					SuggestTemplate: "!strings.EqualFold($x, $y)",
					WhereExpr: ir.FilterExpr{
				...
				},
				{
					Line: 606,
					SyntaxPatterns: []ir.PatternString{
						{Line: 607, Value: "bytes.Equal(bytes.ToLower($x), $y)"},
						{Line: 608, Value: "bytes.Equal(bytes.ToLower($x), bytes.ToLower($y))"},
						{Line: 609, Value: "bytes.Equal($x, bytes.ToLower($y))"},
						{Line: 610, Value: "bytes.Equal(bytes.ToUpper($x), $y)"},
						{Line: 611, Value: "bytes.Equal(bytes.ToUpper($x), bytes.ToUpper($y))"},
						{Line: 612, Value: "bytes.Equal($x, bytes.ToUpper($y))"},
					},
						...
						Args: []ir.FilterExpr{
							{
								...
								Src:  "m[\"x\"].Pure && m[\"y\"].Pure",
								Args: []ir.FilterExpr{
									{Line: 613, Op: ir.FilterVarPureOp, Src: "m[\"x\"].Pure", Value: "x"},
									{Line: 613, Op: ir.FilterVarPureOp, Src: "m[\"y\"].Pure", Value: "y"},
								},
							},
							{
								Line: 613,
								...
								Src:  "m[\"x\"].Text != m[\"y\"].Text",
								Args: []ir.FilterExpr{
									{Line: 613, Op: ir.FilterVarTextOp, Src: "m[\"x\"].Text", Value: "x"},
									{Line: 613, Op: ir.FilterVarTextOp, Src: "m[\"y\"].Text", Value: "y"},
								},
							},
						},
					},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line: 623,
				SyntaxPatterns: []ir.PatternString{
					{Line: 624, Value: "strings.HasPrefix($lit, $s)"},
					{Line: 625, Value: "bytes.HasPrefix($lit, $s)"},
					{Line: 626, Value: "strings.HasSuffix($lit, $s)"},
					{Line: 627, Value: "bytes.HasSuffix($lit, $s)"},
					{Line: 628, Value: "strings.Contains($lit, $s)"},
					{Line: 629, Value: "bytes.Contains($lit, $s)"},
					{Line: 630, Value: "strings.TrimPrefix($lit, $s)"},
					{Line: 631, Value: "bytes.TrimPrefix($lit, $s)"},
					{Line: 632, Value: "strings.TrimSuffix($lit, $s)"},
					{Line: 633, Value: "bytes.TrimSuffix($lit, $s)"},
					{Line: 634, Value: "strings.Split($lit, $s)"},
					{Line: 635, Value: "bytes.Split($lit, $s)"},
				},
					...
					Args: []ir.FilterExpr{
						...
						},
						{
							...
							Args: []ir.FilterExpr{{
								...
								Src:   "m[\"lit\"].Node.Is(`Ident`)",
								Value: "lit",
								Args:  []ir.FilterExpr{{Line: 638, Op: ir.FilterStringOp, Src: "`Ident`", Value: "Ident"}},
							}},
						},
					},
				},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            647,
					SyntaxPatterns:  []ir.PatternString{{Line: 647, Value: "strings.Join([]string{$x, $y}, \"\")"}},
					ReportTemplate:  "suggestion: $x + $y",
					SuggestTemplate: "$x + $y",
				},
				{
					Line:            648,
					SyntaxPatterns:  []ir.PatternString{{Line: 648, Value: "strings.Join([]string{$x, $y, $z}, \"\")"}},
					ReportTemplate:  "suggestion: $x + $y + $z",
					SuggestTemplate: "$x + $y + $z",
				},
				{
					Line:            649,
					SyntaxPatterns:  []ir.PatternString{{Line: 649, Value: "strings.Join([]string{$x, $y}, $glue)"}},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            661,
					SyntaxPatterns:  []ir.PatternString{{Line: 661, Value: "$t.Unix() / 1000"}},
								...
								Args: []ir.FilterExpr{
									{
										...
										Value: "t",
										Args:  []ir.FilterExpr{{Line: 658, Op: ir.FilterStringOp, Src: "`time.Time`", Value: "time.Time"}},
									},
									{
										Line:  662,
										Op:    ir.FilterVarTypeIsOp,
				...
				{
					Line:            666,
					SyntaxPatterns:  []ir.PatternString{{Line: 666, Value: "$t.UnixNano() * 1000"}},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            681,
					SyntaxPatterns:  []ir.PatternString{{Line: 681, Value: "!$t.Before($tt)"}},
						...
						Args: []ir.FilterExpr{
							{
								...
								Src:   "m[\"t\"].Type.Is(`time.Time`)",
								Value: "t",
								Args:  []ir.FilterExpr{{Line: 678, Op: ir.FilterStringOp, Src: "`time.Time`", Value: "time.Time"}},
							},
							{
								Line:  682,
								Op:    ir.FilterVarTypeIsOp,
				...
				{
					Line:            685,
					SyntaxPatterns:  []ir.PatternString{{Line: 685, Value: "!$t.After($tt)"}},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:           699,
					SyntaxPatterns: []ir.PatternString{{Line: 699, Value: "type $x struct { $*_; sync.Mutex; $*_ }"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "isExported(m[\"x\"])",
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 696, Op: ir.FilterStringOp, Src: "`^\\p{Lu}`", Value: "^\\p{Lu}"}},
					},
				},
				{
					Line:           703,
					SyntaxPatterns: []ir.PatternString{{Line: 703, Value: "type $x struct { $*_; *sync.Mutex; $*_ }"}},
					ReportTemplate: "don't embed *sync.Mutex",
					WhereExpr: ir.FilterExpr{
						Line:  704,
						Op:    ir.FilterVarTextMatchesOp,
				...
				{
					Line:           707,
					SyntaxPatterns: []ir.PatternString{{Line: 707, Value: "type $x struct { $*_; sync.RWMutex; $*_ }"}},
				...
				{
					Line:           711,
					SyntaxPatterns: []ir.PatternString{{Line: 711, Value: "type $x struct { $*_; *sync.RWMutex; $*_ }"}},
					ReportTemplate: "don't embed *sync.RWMutex",
					WhereExpr: ir.FilterExpr{
						Line:  712,
						Op:    ir.FilterVarTextMatchesOp,
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            721,
					SyntaxPatterns:  []ir.PatternString{{Line: 721, Value: "$x = sort.IntSlice($x)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "m[\"x\"].Type.Is(`[]int`)",
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 722, Op: ir.FilterStringOp, Src: "`[]int`", Value: "[]int"}},
					},
				},
				{
					Line:            726,
					SyntaxPatterns:  []ir.PatternString{{Line: 726, Value: "$x = sort.Float64Slice($x)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 727, Op: ir.FilterStringOp, Src: "`[]float64`", Value: "[]float64"}},
					},
				},
				{
					Line:            731,
					SyntaxPatterns:  []ir.PatternString{{Line: 731, Value: "$x = sort.StringSlice($x)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "m[\"x\"].Type.Is(`[]string`)",
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 732, Op: ir.FilterStringOp, Src: "`[]string`", Value: "[]string"}},
					},
				},
			},
		},
		{
			...
			Rules: []ir.Rule{{
				Line:           742,
				SyntaxPatterns: []ir.PatternString{{Line: 742, Value: "$pkg.$err = $x"}},
					...
					Args: []ir.FilterExpr{
						{
							...
							Value: "err",
							Args:  []ir.FilterExpr{{Line: 743, Op: ir.FilterStringOp, Src: "`error`", Value: "error"}},
						},
						{
							Line:  743,
							Op:    ir.FilterVarObjectIsOp,
							Src:   "m[\"pkg\"].Object.Is(`PkgName`)",
							Value: "pkg",
							Args:  []ir.FilterExpr{{Line: 743, Op: ir.FilterStringOp, Src: "`PkgName`", Value: "PkgName"}},
						},
					},
				},
			}},
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:           752,
					SyntaxPatterns: []ir.PatternString{{Line: 752, Value: "var()"}},
					ReportTemplate: "empty var() block",
				},
				{
					Line:           753,
					SyntaxPatterns: []ir.PatternString{{Line: 753, Value: "const()"}},
					ReportTemplate: "empty const() block",
				},
				{
					Line:           754,
					SyntaxPatterns: []ir.PatternString{{Line: 754, Value: "type()"}},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            762,
					SyntaxPatterns:  []ir.PatternString{{Line: 762, Value: "fmt.Errorf($f)"}},
				...
				{
					Line:            767,
					SyntaxPatterns:  []ir.PatternString{{Line: 767, Value: "fmt.Errorf($f($*args))"}},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            777,
					SyntaxPatterns:  []ir.PatternString{{Line: 777, Value: "strings.Compare($s1, $s2) == 0"}},
				...
				},
				{
					Line: 780,
					SyntaxPatterns: []ir.PatternString{
						{Line: 780, Value: "strings.Compare($s1, $s2) == -1"},
						{Line: 781, Value: "strings.Compare($s1, $s2) < 0"},
					},
					ReportTemplate:  "suggestion: $s1 < $s2",
					SuggestTemplate: "$s1 < $s2",
				},
				{
					Line: 784,
					SyntaxPatterns: []ir.PatternString{
						{Line: 784, Value: "strings.Compare($s1, $s2) == 1"},
						{Line: 785, Value: "strings.Compare($s1, $s2) > 0"},
					},
					ReportTemplate:  "suggestion: $s1 > $s2",
					SuggestTemplate: "$s1 > $s2",
				},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line: 794,
				SyntaxPatterns: []ir.PatternString{
					{Line: 795, Value: "if $err := $_($*_); $err2 != nil { $*_ }"},
					{Line: 796, Value: "if $err = $_($*_); $err2 != nil { $*_ }"},
					{Line: 797, Value: "if $*_, $err := $_($*_); $err2 != nil { $*_ }"},
					{Line: 798, Value: "if $*_, $err = $_($*_); $err2 != nil { $*_ }"},
				},
				...
				WhereExpr: ir.FilterExpr{
					...
					Args: []ir.FilterExpr{
							...
							Args: []ir.FilterExpr{
								{
									...
									Value: "err",
									Args:  []ir.FilterExpr{{Line: 799, Op: ir.FilterStringOp, Src: "\"error\"", Value: "error"}},
								},
								{
									Line:  799,
									Op:    ir.FilterVarTypeImplementsOp,
						...
						},
						{
							...
							Args: []ir.FilterExpr{
								{Line: 800, Op: ir.FilterVarTextOp, Src: "m[\"err\"].Text", Value: "err"},
								{Line: 800, Op: ir.FilterVarTextOp, Src: "m[\"err2\"].Text", Value: "err2"},
							},
						},
					},
				},
		...
		},
		{
			...
			Rules: []ir.Rule{
						...
						Args: []ir.FilterExpr{
							...
							},
							{
								...
								Args: []ir.FilterExpr{{
									...
									Src:   "m[\"test\"].Text.Matches(\"test.*\")",
									Value: "test",
									Args:  []ir.FilterExpr{{Line: 812, Op: ir.FilterStringOp, Src: "\"test.*\"", Value: "test.*"}},
								}},
							},
						},
					},
				...
				{
					Line:           815,
					SyntaxPatterns: []ir.PatternString{{Line: 815, Value: "func $bench($_ *testing.B) { $*_ }"}},
						...
						Args: []ir.FilterExpr{
							{
								...
								Args: []ir.FilterExpr{{
									...
									Src:   "m[\"bench\"].Text.Matches(\"Benchmark.*\")",
									Value: "bench",
									Args:  []ir.FilterExpr{{Line: 816, Op: ir.FilterStringOp, Src: "\"Benchmark.*\"", Value: "Benchmark.*"}},
								}},
							},
							{
								Line: 817,
								...
								Args: []ir.FilterExpr{{
									...
									Src:   "m[\"bench\"].Text.Matches(\"bench.*\")",
									Value: "bench",
									Args:  []ir.FilterExpr{{Line: 817, Op: ir.FilterStringOp, Src: "\"bench.*\"", Value: "bench.*"}},
								}},
							},
						},
					},
				...
				{
					Line:           820,
					SyntaxPatterns: []ir.PatternString{{Line: 820, Value: "func $test($_ *testing.T) { $*_ }"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "m[\"test\"].Text.Matches(\"^test.*\")",
						Value: "test",
						Args:  []ir.FilterExpr{{Line: 821, Op: ir.FilterStringOp, Src: "\"^test.*\"", Value: "^test.*"}},
					},
				},
				{
					Line:           824,
					SyntaxPatterns: []ir.PatternString{{Line: 824, Value: "func $bench($_ *testing.B) { $*_ }"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "bench",
						Args:  []ir.FilterExpr{{Line: 825, Op: ir.FilterStringOp, Src: "\"^bench(mark)?.*\"", Value: "^bench(mark)?.*"}},
					},
				},
			},
		},
