		...
		ir.RuleGroup{
			...
			Rules: []ir.Rule{
				ir.Rule{
					Line: 644,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 644, Value: "$t.Unix() / 1000"},
					},
							...
							ir.FilterExpr{
								...
								Args: []ir.FilterExpr{
									ir.FilterExpr{
										...
										Value: "t",
										Args: []ir.FilterExpr{
											ir.FilterExpr{Line: 646, Op: ir.FilterStringOp, Src: "`time.Time`", Value: "time.Time"},
										},
									},
									ir.FilterExpr{
										Line:  646,
				...
				ir.Rule{
					Line: 650,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 650, Value: "$t.UnixNano() * 1000"},
					},
							...
							ir.FilterExpr{
								...
								Args: []ir.FilterExpr{
									ir.FilterExpr{
										...
										Value: "t",
										Args: []ir.FilterExpr{
											ir.FilterExpr{Line: 652, Op: ir.FilterStringOp, Src: "`time.Time`", Value: "time.Time"},
										},
									},
									ir.FilterExpr{
										Line:  652,
			...
			Rules: []ir.Rule{
				ir.Rule{
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "x",
						Args: []ir.FilterExpr{
							ir.FilterExpr{Line: 668, Op: ir.FilterStringOp, Src: "`^\\p{Lu}`", Value: "^\\p{Lu}"},
						},
					},
				},
				ir.Rule{
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "x",
						Args: []ir.FilterExpr{
							ir.FilterExpr{Line: 672, Op: ir.FilterStringOp, Src: "`^\\p{Lu}`", Value: "^\\p{Lu}"},
						},
					},
				},
				ir.Rule{
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "x",
						Args: []ir.FilterExpr{
							ir.FilterExpr{Line: 676, Op: ir.FilterStringOp, Src: "`^\\p{Lu}`", Value: "^\\p{Lu}"},
						},
					},
				},
				ir.Rule{
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "x",
						Args: []ir.FilterExpr{
							ir.FilterExpr{Line: 680, Op: ir.FilterStringOp, Src: "`^\\p{Lu}`", Value: "^\\p{Lu}"},
						},
					},
				},
			},
