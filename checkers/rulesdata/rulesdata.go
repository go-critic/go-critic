					...
					WhereExpr: ir.FilterExpr{
						...
						Args: []ir.FilterExpr{
							ir.FilterExpr{
								...
								Value: "w",
								Args: []ir.FilterExpr{
									ir.FilterExpr{Line: 341, Op: ir.FilterStringOp, Src: "\"io.ByteWriter\"", Value: "io.ByteWriter"},
								},
							},
							ir.FilterExpr{
								Line: 341,
		...
		ir.RuleGroup{
			...
			Rules: []ir.Rule{
				ir.Rule{
					Line: 350,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 350, Value: "$w.Write([]byte(fmt.Sprint($*args)))"},
					},
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "w",
						Args: []ir.FilterExpr{
							ir.FilterExpr{Line: 351, Op: ir.FilterStringOp, Src: "\"io.Writer\"", Value: "io.Writer"},
						},
					},
				},
				ir.Rule{
					Line: 355,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 355, Value: "$w.Write([]byte(fmt.Sprintf($*args)))"},
					},
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "w",
						Args: []ir.FilterExpr{
							ir.FilterExpr{Line: 356, Op: ir.FilterStringOp, Src: "\"io.Writer\"", Value: "io.Writer"},
						},
					},
				},
				ir.Rule{
					Line: 360,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 360, Value: "$w.Write([]byte(fmt.Sprintln($*args)))"},
					},
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "w",
						Args: []ir.FilterExpr{
							ir.FilterExpr{Line: 361, Op: ir.FilterStringOp, Src: "\"io.Writer\"", Value: "io.Writer"},
						},
					},
				},
				ir.Rule{
					Line: 365,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 365, Value: "io.WriteString($w, fmt.Sprint($*args))"},
					},
				...
				ir.Rule{
					Line: 366,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 366, Value: "io.WriteString($w, fmt.Sprintf($*args))"},
					},
				...
				ir.Rule{
					Line: 367,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 367, Value: "io.WriteString($w, fmt.Sprintln($*args))"},
					},
		...
		ir.RuleGroup{
			...
			Rules: []ir.Rule{
				ir.Rule{
					Line: 375,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 375, Value: "$x.Equal($x)"},
						ir.PatternString{Line: 375, Value: "$x.Equals($x)"},
						ir.PatternString{Line: 375, Value: "$x.Compare($x)"},
						ir.PatternString{Line: 375, Value: "$x.Cmp($x)"},
					},
				...
				ir.Rule{
					Line: 379,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 379, Value: "copy($x, $x)"},
						ir.PatternString{Line: 380, Value: "math.Max($x, $x)"},
						ir.PatternString{Line: 381, Value: "math.Min($x, $x)"},
						ir.PatternString{Line: 382, Value: "reflect.Copy($x, $x)"},
						ir.PatternString{Line: 383, Value: "reflect.DeepEqual($x, $x)"},
						ir.PatternString{Line: 384, Value: "strings.Contains($x, $x)"},
						ir.PatternString{Line: 385, Value: "strings.Compare($x, $x)"},
						ir.PatternString{Line: 386, Value: "strings.EqualFold($x, $x)"},
						ir.PatternString{Line: 387, Value: "strings.HasPrefix($x, $x)"},
						ir.PatternString{Line: 388, Value: "strings.HasSuffix($x, $x)"},
						ir.PatternString{Line: 389, Value: "strings.Index($x, $x)"},
						ir.PatternString{Line: 390, Value: "strings.LastIndex($x, $x)"},
						ir.PatternString{Line: 391, Value: "strings.Split($x, $x)"},
						ir.PatternString{Line: 392, Value: "strings.SplitAfter($x, $x)"},
						ir.PatternString{Line: 393, Value: "strings.SplitAfterN($x, $x, $_)"},
						ir.PatternString{Line: 394, Value: "strings.SplitN($x, $x, $_)"},
						ir.PatternString{Line: 395, Value: "strings.Replace($_, $x, $x, $_)"},
						ir.PatternString{Line: 396, Value: "strings.ReplaceAll($_, $x, $x)"},
						ir.PatternString{Line: 397, Value: "bytes.Contains($x, $x)"},
						ir.PatternString{Line: 398, Value: "bytes.Compare($x, $x)"},
						ir.PatternString{Line: 399, Value: "bytes.Equal($x, $x)"},
						ir.PatternString{Line: 400, Value: "bytes.EqualFold($x, $x)"},
						ir.PatternString{Line: 401, Value: "bytes.HasPrefix($x, $x)"},
						ir.PatternString{Line: 402, Value: "bytes.HasSuffix($x, $x)"},
						ir.PatternString{Line: 403, Value: "bytes.Index($x, $x)"},
						ir.PatternString{Line: 404, Value: "bytes.LastIndex($x, $x)"},
						ir.PatternString{Line: 405, Value: "bytes.Split($x, $x)"},
						ir.PatternString{Line: 406, Value: "bytes.SplitAfter($x, $x)"},
						ir.PatternString{Line: 407, Value: "bytes.SplitAfterN($x, $x, $_)"},
						ir.PatternString{Line: 408, Value: "bytes.SplitN($x, $x, $_)"},
						ir.PatternString{Line: 409, Value: "bytes.Replace($_, $x, $x, $_)"},
						ir.PatternString{Line: 410, Value: "bytes.ReplaceAll($_, $x, $x)"},
						ir.PatternString{Line: 411, Value: "types.Identical($x, $x)"},
						ir.PatternString{Line: 412, Value: "types.IdenticalIgnoreTags($x, $x)"},
						ir.PatternString{Line: 413, Value: "draw.Draw($x, $_, $x, $_, $_)"},
					},
		...
		ir.RuleGroup{
			...
			Rules: []ir.Rule{
				ir.Rule{
					Line: 423,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 423, Value: "if $_ { $*_; http.Error($w, $err, $code) }"},
					},
		...
		ir.RuleGroup{
			...
			Rules: []ir.Rule{
				ir.Rule{
					Line: 433,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 433, Value: "$x + string(os.PathSeparator) + $y"},
					},
					...
					WhereExpr: ir.FilterExpr{
						...
						Args: []ir.FilterExpr{
							ir.FilterExpr{
								...
								Value: "x",
								Args: []ir.FilterExpr{
									ir.FilterExpr{Line: 434, Op: ir.FilterStringOp, Src: "`string`", Value: "string"},
								},
							},
							ir.FilterExpr{
								Line:  434,
		...
		ir.RuleGroup{
			...
			Rules: []ir.Rule{
				ir.Rule{
					Line: 444,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 444, Value: "$w.Write([]byte($s))"},
					},
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "w",
						Args: []ir.FilterExpr{
							ir.FilterExpr{Line: 445, Op: ir.FilterStringOp, Src: "\"io.StringWriter\"", Value: "io.StringWriter"},
						},
					},
				},
				ir.Rule{
					Line: 449,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 449, Value: "io.WriteString($w, $s)"},
					},
					ReportTemplate:  "$w.WriteString($s) should be preferred to the $$",
					SuggestTemplate: "$w.WriteString($s)",
					WhereExpr: ir.FilterExpr{
						...
						Value: "w",
						Args: []ir.FilterExpr{
							ir.FilterExpr{Line: 450, Op: ir.FilterStringOp, Src: "\"io.StringWriter\"", Value: "io.StringWriter"},
						},
					},
				},
			},
		...
		ir.RuleGroup{
			...
			Rules: []ir.Rule{
				ir.Rule{
					Line: 460,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 460, Value: "for $i := 0; $i < len($xs); $i++ { $xs[$i] = $zero }"},
					},
		...
		ir.RuleGroup{
			...
			Rules: []ir.Rule{
				ir.Rule{
					Line: 470,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 470, Value: "$_, $ok := $m.Load($k); if $ok { $m.Delete($k); $*_ }"},
					},
					...
					WhereExpr: ir.FilterExpr{
						...
						Args: []ir.FilterExpr{
							...
							ir.FilterExpr{
								...
								Value: "m",
								Args: []ir.FilterExpr{
									ir.FilterExpr{Line: 472, Op: ir.FilterStringOp, Src: "`*sync.Map`", Value: "*sync.Map"},
								},
							},
						},
					},
		...
		ir.RuleGroup{
			...
			Rules: []ir.Rule{
				ir.Rule{
					Line: 481,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 481, Value: "fmt.Sprintf($s, $*_)"},
					},
					...
					WhereExpr: ir.FilterExpr{
						...
						Args: []ir.FilterExpr{
							ir.FilterExpr{
								...
								Value: "s",
								Args: []ir.FilterExpr{
									ir.FilterExpr{Line: 482, Op: ir.FilterStringOp, Src: "\"^`.*\\\"%s\\\".*`$\"", Value: "^`.*\"%s\".*`$"},
								},
							},
							ir.FilterExpr{
								Line:  483,
								...
								Value: "s",
								Args: []ir.FilterExpr{
									ir.FilterExpr{Line: 483, Op: ir.FilterStringOp, Src: "`^\".*\\\\\"%s\\\\\".*\"$`", Value: "^\".*\\\\\"%s\\\\\".*\"$"},
								},
							},
						},
					},
		...
		ir.RuleGroup{
			...
			Rules: []ir.Rule{
				ir.Rule{
					Line: 492,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 492, Value: "$x[len($x)]"},
					},
					...
					WhereExpr: ir.FilterExpr{
						...
						Args: []ir.FilterExpr{
							ir.FilterExpr{Line: 493, Op: ir.FilterVarPureOp, Src: "m[\"x\"].Pure", Value: "x"},
							ir.FilterExpr{
								Line:  493,
								Op:    ir.FilterVarTypeIsOp,
								Src:   "m[\"x\"].Type.Is(`[]$_`)",
								Value: "x",
								Args: []ir.FilterExpr{
									ir.FilterExpr{Line: 493, Op: ir.FilterStringOp, Src: "`[]$_`", Value: "[]$_"},
								},
							},
						},
					},
				...
				ir.Rule{
					Line: 500,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 501, Value: "$i := strings.Index($s, $_); $_ := $slicing[$i:]"},
						ir.PatternString{Line: 502, Value: "$i := strings.Index($s, $_); $_ = $slicing[$i:]"},
						ir.PatternString{Line: 503, Value: "$i := bytes.Index($s, $_); $_ := $slicing[$i:]"},
						ir.PatternString{Line: 504, Value: "$i := bytes.Index($s, $_); $_ = $slicing[$i:]"},
					},
					...
					WhereExpr: ir.FilterExpr{
						...
						Args: []ir.FilterExpr{
							ir.FilterExpr{Line: 505, Op: ir.FilterVarTextOp, Src: "m[\"s\"].Text", Value: "s"},
							ir.FilterExpr{Line: 505, Op: ir.FilterVarTextOp, Src: "m[\"slicing\"].Text", Value: "slicing"},
						},
					},
					LocationVar: "slicing",
				},
				ir.Rule{
					Line: 509,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 510, Value: "$i := strings.Index($s, $_); $_ := $slicing[:$i]"},
						ir.PatternString{Line: 511, Value: "$i := strings.Index($s, $_); $_ = $slicing[:$i]"},
						ir.PatternString{Line: 512, Value: "$i := bytes.Index($s, $_); $_ := $slicing[:$i]"},
						ir.PatternString{Line: 513, Value: "$i := bytes.Index($s, $_); $_ = $slicing[:$i]"},
					},
					ReportTemplate: "Index() can return -1; maybe you wanted to do $s[:$i+1]",
					WhereExpr: ir.FilterExpr{
						Line: 514,
						...
						Src:  "m[\"s\"].Text == m[\"slicing\"].Text",
						Args: []ir.FilterExpr{
							ir.FilterExpr{Line: 514, Op: ir.FilterVarTextOp, Src: "m[\"s\"].Text", Value: "s"},
							ir.FilterExpr{Line: 514, Op: ir.FilterVarTextOp, Src: "m[\"slicing\"].Text", Value: "slicing"},
						},
					},
					LocationVar: "slicing",
				},
				ir.Rule{
					Line: 518,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 519, Value: "$s[strings.Index($s, $_):]"},
						ir.PatternString{Line: 520, Value: "$s[:strings.Index($s, $_)]"},
						ir.PatternString{Line: 521, Value: "$s[bytes.Index($s, $_):]"},
						ir.PatternString{Line: 522, Value: "$s[:bytes.Index($s, $_)]"},
					},
		...
		ir.RuleGroup{
			...
			Rules: []ir.Rule{
				ir.Rule{
					Line: 531,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 531, Value: "$s[:]"},
					},
					...
					WhereExpr: ir.FilterExpr{
						...
						Args: []ir.FilterExpr{
							...
							ir.FilterExpr{
								...
								Value: "s",
								Args: []ir.FilterExpr{
									ir.FilterExpr{Line: 532, Op: ir.FilterStringOp, Src: "`[]$_`", Value: "[]$_"},
								},
							},
						},
					},
		...
		ir.RuleGroup{
			...
			Rules: []ir.Rule{
				ir.Rule{
					Line: 566,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 567, Value: "strings.ToLower($x) == $y"},
						ir.PatternString{Line: 568, Value: "strings.ToLower($x) == strings.ToLower($y)"},
						ir.PatternString{Line: 569, Value: "$x == strings.ToLower($y)"},
						ir.PatternString{Line: 570, Value: "strings.ToUpper($x) == $y"},
						ir.PatternString{Line: 571, Value: "strings.ToUpper($x) == strings.ToUpper($y)"},
						ir.PatternString{Line: 572, Value: "$x == strings.ToUpper($y)"},
					},
					...
					WhereExpr: ir.FilterExpr{
						...
						Args: []ir.FilterExpr{
							ir.FilterExpr{
								...
								Src:  "m[\"x\"].Pure && m[\"y\"].Pure",
								Args: []ir.FilterExpr{
									ir.FilterExpr{Line: 573, Op: ir.FilterVarPureOp, Src: "m[\"x\"].Pure", Value: "x"},
									ir.FilterExpr{Line: 573, Op: ir.FilterVarPureOp, Src: "m[\"y\"].Pure", Value: "y"},
								},
							},
							ir.FilterExpr{
								Line: 573,
								...
								Args: []ir.FilterExpr{
									ir.FilterExpr{Line: 573, Op: ir.FilterVarTextOp, Src: "m[\"x\"].Text", Value: "x"},
									ir.FilterExpr{Line: 573, Op: ir.FilterVarTextOp, Src: "m[\"y\"].Text", Value: "y"},
								},
							},
						},
					},
				...
				ir.Rule{
					Line: 578,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 579, Value: "strings.ToLower($x) != $y"},
						ir.PatternString{Line: 580, Value: "strings.ToLower($x) != strings.ToLower($y)"},
						ir.PatternString{Line: 581, Value: "$x != strings.ToLower($y)"},
						ir.PatternString{Line: 582, Value: "strings.ToUpper($x) != $y"},
						ir.PatternString{Line: 583, Value: "strings.ToUpper($x) != strings.ToUpper($y)"},
						ir.PatternString{Line: 584, Value: "$x != strings.ToUpper($y)"},
					},
					ReportTemplate:  "consider replacing with !strings.EqualFold($x, $y)",
					SuggestTemplate: "!strings.EqualFold($x, $y)",
					WhereExpr: ir.FilterExpr{
						...
						Args: []ir.FilterExpr{
							ir.FilterExpr{
								...
								Src:  "m[\"x\"].Pure && m[\"y\"].Pure",
								Args: []ir.FilterExpr{
									ir.FilterExpr{Line: 585, Op: ir.FilterVarPureOp, Src: "m[\"x\"].Pure", Value: "x"},
									ir.FilterExpr{Line: 585, Op: ir.FilterVarPureOp, Src: "m[\"y\"].Pure", Value: "y"},
								},
							},
							ir.FilterExpr{
								Line: 585,
								...
								Src:  "m[\"x\"].Text != m[\"y\"].Text",
								Args: []ir.FilterExpr{
									ir.FilterExpr{Line: 585, Op: ir.FilterVarTextOp, Src: "m[\"x\"].Text", Value: "x"},
									ir.FilterExpr{Line: 585, Op: ir.FilterVarTextOp, Src: "m[\"y\"].Text", Value: "y"},
								},
							},
						},
					},
				...
				ir.Rule{
					Line: 590,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 591, Value: "bytes.Equal(bytes.ToLower($x), $y)"},
						ir.PatternString{Line: 592, Value: "bytes.Equal(bytes.ToLower($x), bytes.ToLower($y))"},
						ir.PatternString{Line: 593, Value: "bytes.Equal($x, bytes.ToLower($y))"},
						ir.PatternString{Line: 594, Value: "bytes.Equal(bytes.ToUpper($x), $y)"},
						ir.PatternString{Line: 595, Value: "bytes.Equal(bytes.ToUpper($x), bytes.ToUpper($y))"},
						ir.PatternString{Line: 596, Value: "bytes.Equal($x, bytes.ToUpper($y))"},
					},
					...
					WhereExpr: ir.FilterExpr{
						...
						Args: []ir.FilterExpr{
							ir.FilterExpr{
								...
								Src:  "m[\"x\"].Pure && m[\"y\"].Pure",
								Args: []ir.FilterExpr{
									ir.FilterExpr{Line: 597, Op: ir.FilterVarPureOp, Src: "m[\"x\"].Pure", Value: "x"},
									ir.FilterExpr{Line: 597, Op: ir.FilterVarPureOp, Src: "m[\"y\"].Pure", Value: "y"},
								},
							},
							ir.FilterExpr{
								Line: 597,
								...
								Src:  "m[\"x\"].Text != m[\"y\"].Text",
								Args: []ir.FilterExpr{
									ir.FilterExpr{Line: 597, Op: ir.FilterVarTextOp, Src: "m[\"x\"].Text", Value: "x"},
									ir.FilterExpr{Line: 597, Op: ir.FilterVarTextOp, Src: "m[\"y\"].Text", Value: "y"},
								},
							},
						},
					},
		...
		ir.RuleGroup{
			...
			Rules: []ir.Rule{
				ir.Rule{
					Line: 607,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 608, Value: "strings.HasPrefix($lit, $s)"},
						ir.PatternString{Line: 609, Value: "bytes.HasPrefix($lit, $s)"},
						ir.PatternString{Line: 610, Value: "strings.HasSuffix($lit, $s)"},
						ir.PatternString{Line: 611, Value: "bytes.HasSuffix($lit, $s)"},
						ir.PatternString{Line: 612, Value: "strings.Contains($lit, $s)"},
						ir.PatternString{Line: 613, Value: "bytes.Contains($lit, $s)"},
						ir.PatternString{Line: 614, Value: "strings.TrimPrefix($lit, $s)"},
						ir.PatternString{Line: 615, Value: "bytes.TrimPrefix($lit, $s)"},
						ir.PatternString{Line: 616, Value: "strings.TrimSuffix($lit, $s)"},
						ir.PatternString{Line: 617, Value: "bytes.TrimSuffix($lit, $s)"},
						ir.PatternString{Line: 618, Value: "strings.Split($lit, $s)"},
						ir.PatternString{Line: 619, Value: "bytes.Split($lit, $s)"},
					},
							...
							ir.FilterExpr{
								...
								Args: []ir.FilterExpr{
									ir.FilterExpr{
										...
										Value: "lit",
										Args: []ir.FilterExpr{
											ir.FilterExpr{Line: 622, Op: ir.FilterStringOp, Src: "`Ident`", Value: "Ident"},
										},
									},
								},
							},
		...
		ir.RuleGroup{
			...
			Rules: []ir.Rule{
				ir.Rule{
					Line: 631,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 631, Value: "strings.Join([]string{$x, $y}, \"\")"},
					},
				...
				ir.Rule{
					Line: 632,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 632, Value: "strings.Join([]string{$x, $y, $z}, \"\")"},
					},
				...
				ir.Rule{
					Line: 633,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 633, Value: "strings.Join([]string{$x, $y}, $glue)"},
					},
		...
		ir.RuleGroup{
			...
			Rules: []ir.Rule{
				ir.Rule{
					Line: 645,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 645, Value: "$t.Unix() / 1000"},
					},
		...
		ir.RuleGroup{
			...
			Rules: []ir.Rule{
				ir.Rule{
					Line: 665,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 665, Value: "type $x struct { $*_; sync.Mutex; $*_ }"},
					},
				...
				ir.Rule{
					Line: 669,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 669, Value: "type $x struct { $*_; *sync.Mutex; $*_ }"},
					},
					ReportTemplate: "don't embed *sync.Mutex",
					WhereExpr: ir.FilterExpr{
						Line:  670,
				...
				ir.Rule{
					Line: 673,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 673, Value: "type $x struct { $*_; sync.RWMutex; $*_ }"},
					},
				...
				ir.Rule{
					Line: 677,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 677, Value: "type $x struct { $*_; *sync.RWMutex; $*_ }"},
					},
					ReportTemplate: "don't embed *sync.RWMutex",
					WhereExpr: ir.FilterExpr{
						Line:  678,
		...
		ir.RuleGroup{
			...
			Rules: []ir.Rule{
				ir.Rule{
					Line: 687,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 687, Value: "$x = sort.IntSlice($x)"},
					},
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "x",
						Args: []ir.FilterExpr{
							ir.FilterExpr{Line: 688, Op: ir.FilterStringOp, Src: "`[]int`", Value: "[]int"},
						},
					},
				},
				ir.Rule{
					Line: 692,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 692, Value: "$x = sort.Float64Slice($x)"},
					},
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "x",
						Args: []ir.FilterExpr{
							ir.FilterExpr{Line: 693, Op: ir.FilterStringOp, Src: "`[]float64`", Value: "[]float64"},
						},
					},
				},
				ir.Rule{
					Line: 697,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 697, Value: "$x = sort.StringSlice($x)"},
					},
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "x",
						Args: []ir.FilterExpr{
							ir.FilterExpr{Line: 698, Op: ir.FilterStringOp, Src: "`[]string`", Value: "[]string"},
						},
					},
				},
			},
		...
		ir.RuleGroup{
			...
			Rules: []ir.Rule{
				ir.Rule{
					Line: 708,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 708, Value: "$pkg.$err = $x"},
					},
					...
					WhereExpr: ir.FilterExpr{
						...
						Args: []ir.FilterExpr{
							ir.FilterExpr{
								...
								Value: "err",
								Args: []ir.FilterExpr{
									ir.FilterExpr{Line: 709, Op: ir.FilterStringOp, Src: "`error`", Value: "error"},
								},
							},
							ir.FilterExpr{
								Line:  709,
								...
								Value: "pkg",
								Args: []ir.FilterExpr{
									ir.FilterExpr{Line: 709, Op: ir.FilterStringOp, Src: "`PkgName`", Value: "PkgName"},
								},
							},
						},
					},
		...
		ir.RuleGroup{
			...
			Rules: []ir.Rule{
				ir.Rule{
					Line: 718,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 718, Value: "var()"},
					},
				...
				ir.Rule{
					Line: 719,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 719, Value: "const()"},
					},
				...
				ir.Rule{
					Line: 720,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 720, Value: "type()"},
					},
		...
		ir.RuleGroup{
			...
			Rules: []ir.Rule{
				ir.Rule{
					Line: 728,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 728, Value: "fmt.Errorf($f)"},
					},
				...
				ir.Rule{
					Line: 733,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 733, Value: "fmt.Errorf($f($*args))"},
					},
