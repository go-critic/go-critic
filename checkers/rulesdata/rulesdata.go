	...
	RuleGroups: []ir.RuleGroup{
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            670,
					SyntaxPatterns:  []ir.PatternString{{Line: 670, Value: "!$t.Before($tt)"}},
						...
						Args: []ir.FilterExpr{
							{
								...
								Src:   "m[\"t\"].Type.Is(`time.Time`)",
								Value: "t",
								Args:  []ir.FilterExpr{{Line: 667, Op: ir.FilterStringOp, Src: "`time.Time`", Value: "time.Time"}},
							},
							{
								Line:  671,
								Op:    ir.FilterVarTypeIsOp,
				...
				{
					Line:            674,
					SyntaxPatterns:  []ir.PatternString{{Line: 674, Value: "!$t.After($tt)"}},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:           688,
					SyntaxPatterns: []ir.PatternString{{Line: 688, Value: "type $x struct { $*_; sync.Mutex; $*_ }"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "isExported(m[\"x\"])",
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 685, Op: ir.FilterStringOp, Src: "`^\\p{Lu}`", Value: "^\\p{Lu}"}},
					},
				},
				{
					Line:           692,
					SyntaxPatterns: []ir.PatternString{{Line: 692, Value: "type $x struct { $*_; *sync.Mutex; $*_ }"}},
					ReportTemplate: "don't embed *sync.Mutex",
					WhereExpr: ir.FilterExpr{
						Line:  693,
						Op:    ir.FilterVarTextMatchesOp,
				...
				{
					Line:           696,
					SyntaxPatterns: []ir.PatternString{{Line: 696, Value: "type $x struct { $*_; sync.RWMutex; $*_ }"}},
				...
				{
					Line:           700,
					SyntaxPatterns: []ir.PatternString{{Line: 700, Value: "type $x struct { $*_; *sync.RWMutex; $*_ }"}},
					ReportTemplate: "don't embed *sync.RWMutex",
					WhereExpr: ir.FilterExpr{
						Line:  701,
						Op:    ir.FilterVarTextMatchesOp,
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            710,
					SyntaxPatterns:  []ir.PatternString{{Line: 710, Value: "$x = sort.IntSlice($x)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "m[\"x\"].Type.Is(`[]int`)",
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 711, Op: ir.FilterStringOp, Src: "`[]int`", Value: "[]int"}},
					},
				},
				{
					Line:            715,
					SyntaxPatterns:  []ir.PatternString{{Line: 715, Value: "$x = sort.Float64Slice($x)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 716, Op: ir.FilterStringOp, Src: "`[]float64`", Value: "[]float64"}},
					},
				},
				{
					Line:            720,
					SyntaxPatterns:  []ir.PatternString{{Line: 720, Value: "$x = sort.StringSlice($x)"}},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line:           731,
				SyntaxPatterns: []ir.PatternString{{Line: 731, Value: "$pkg.$err = $x"}},
					...
					Args: []ir.FilterExpr{
						{
							...
							Value: "err",
							Args:  []ir.FilterExpr{{Line: 732, Op: ir.FilterStringOp, Src: "`error`", Value: "error"}},
						},
						{
							Line:  732,
							Op:    ir.FilterVarObjectIsOp,
							Src:   "m[\"pkg\"].Object.Is(`PkgName`)",
							Value: "pkg",
							Args:  []ir.FilterExpr{{Line: 732, Op: ir.FilterStringOp, Src: "`PkgName`", Value: "PkgName"}},
						},
					},
				},
			}},
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:           741,
					SyntaxPatterns: []ir.PatternString{{Line: 741, Value: "var()"}},
					ReportTemplate: "empty var() block",
				},
				{
					Line:           742,
					SyntaxPatterns: []ir.PatternString{{Line: 742, Value: "const()"}},
					ReportTemplate: "empty const() block",
				},
				{
					Line:           743,
					SyntaxPatterns: []ir.PatternString{{Line: 743, Value: "type()"}},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            751,
					SyntaxPatterns:  []ir.PatternString{{Line: 751, Value: "fmt.Errorf($f)"}},
				...
				{
					Line:            756,
					SyntaxPatterns:  []ir.PatternString{{Line: 756, Value: "fmt.Errorf($f($*args))"}},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            766,
					SyntaxPatterns:  []ir.PatternString{{Line: 766, Value: "strings.Compare($s1, $s2) == 0"}},
				...
				},
				{
					Line: 769,
					SyntaxPatterns: []ir.PatternString{
						{Line: 769, Value: "strings.Compare($s1, $s2) == -1"},
						{Line: 770, Value: "strings.Compare($s1, $s2) < 0"},
					},
					ReportTemplate:  "suggestion: $s1 < $s2",
					SuggestTemplate: "$s1 < $s2",
				},
				{
					Line: 773,
					SyntaxPatterns: []ir.PatternString{
						{Line: 773, Value: "strings.Compare($s1, $s2) == 1"},
						{Line: 774, Value: "strings.Compare($s1, $s2) > 0"},
					},
					ReportTemplate:  "suggestion: $s1 > $s2",
					SuggestTemplate: "$s1 > $s2",
				},
				...
				WhereExpr: ir.FilterExpr{
					...
					Args: []ir.FilterExpr{
							...
							Args: []ir.FilterExpr{
								{
									...
									Value: "err",
									Args:  []ir.FilterExpr{{Line: 788, Op: ir.FilterStringOp, Src: "\"error\"", Value: "error"}},
								},
								{
									Line:  788,
									Op:    ir.FilterVarTypeImplementsOp,
						...
						},
						{
							...
							Args: []ir.FilterExpr{
								{Line: 789, Op: ir.FilterVarTextOp, Src: "m[\"err\"].Text", Value: "err"},
								{Line: 789, Op: ir.FilterVarTextOp, Src: "m[\"err2\"].Text", Value: "err2"},
							},
						},
					},
				},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:           799,
					SyntaxPatterns: []ir.PatternString{{Line: 799, Value: "$*_; sync.OnceFunc($x); $*_;"}},
				...
				{
					Line:           803,
					SyntaxPatterns: []ir.PatternString{{Line: 803, Value: "sync.OnceFunc($x)()"}},
