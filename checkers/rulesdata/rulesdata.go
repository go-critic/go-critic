		...
		ir.RuleGroup{
			...
			Rules: []ir.Rule{
				...
				ir.Rule{
					Line: 749,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 749, Value: "strings.Compare($s1, $s2) < $i"},
						ir.PatternString{Line: 750, Value: "$i > strings.Compare($s1, $s2)"},
						ir.PatternString{Line: 751, Value: "strings.Compare($s1, $s2) == -1"},
						ir.PatternString{Line: 752, Value: "-1 == strings.Compare($s1, $s2)"},
					},
					ReportTemplate:  "suggestion: $s1 < $s2",
					SuggestTemplate: "$s1 < $s2",
					WhereExpr: ir.FilterExpr{
				...
				ir.Rule{
					Line: 757,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 757, Value: "strings.Compare($s1, $s2) > $i"},
						ir.PatternString{Line: 758, Value: "$i < strings.Compare($s1, $s2)"},
						ir.PatternString{Line: 759, Value: "strings.Compare($s1, $s2) == 1"},
						ir.PatternString{Line: 760, Value: "1 == strings.Compare($s1, $s2)"},
					},
					ReportTemplate:  "suggestion: $s1 > $s2",
					SuggestTemplate: "$s1 > $s2",
					WhereExpr: ir.FilterExpr{
