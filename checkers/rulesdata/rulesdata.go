...
var PrecompiledRules = &ir.File{
	...
	RuleGroups: []ir.RuleGroup{
		...
		},
		{
			...
			MatcherName: "m",
			DocTags:     []string{"diagnostic", "experimental"},
			DocSummary:  "Detects manually quoted \"%s\" directives that can be replaced with %q or %#q",
			...
			Rules: []ir.Rule{
				...
				{
					Line:           498,
					SyntaxPatterns: []ir.PatternString{{Line: 498, Value: "fmt.Sprintf($s, $*_)"}},
					ReportTemplate: "use %#q instead of \"`%s`\" for backquoted strings",
					WhereExpr: ir.FilterExpr{
						Line:  499,
						Op:    ir.FilterVarTextMatchesOp,
						Src:   "m[\"s\"].Text.Matches(\"^\\\".*`%s`.*\\\"$\")",
			...
			Rules: []ir.Rule{
				{
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "isExported(m[\"x\"])",
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 678, Op: ir.FilterStringOp, Src: "`^\\p{Lu}`", Value: "^\\p{Lu}"}},
					},
				},
				{
					Line:           685,
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            703,
					SyntaxPatterns:  []ir.PatternString{{Line: 703, Value: "$x = sort.IntSlice($x)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "m[\"x\"].Type.Is(`[]int`)",
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 704, Op: ir.FilterStringOp, Src: "`[]int`", Value: "[]int"}},
					},
				},
				{
					Line:            708,
					SyntaxPatterns:  []ir.PatternString{{Line: 708, Value: "$x = sort.Float64Slice($x)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 709, Op: ir.FilterStringOp, Src: "`[]float64`", Value: "[]float64"}},
					},
				},
				{
					Line:            713,
					SyntaxPatterns:  []ir.PatternString{{Line: 713, Value: "$x = sort.StringSlice($x)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "m[\"x\"].Type.Is(`[]string`)",
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 714, Op: ir.FilterStringOp, Src: "`[]string`", Value: "[]string"}},
					},
				},
			},
		},
		{
			...
			Rules: []ir.Rule{{
				Line:           724,
				SyntaxPatterns: []ir.PatternString{{Line: 724, Value: "$pkg.$err = $x"}},
					...
					Args: []ir.FilterExpr{
						{
							...
							Value: "err",
							Args:  []ir.FilterExpr{{Line: 725, Op: ir.FilterStringOp, Src: "`error`", Value: "error"}},
						},
						{
							Line:  725,
							Op:    ir.FilterVarObjectIsOp,
							Src:   "m[\"pkg\"].Object.Is(`PkgName`)",
							Value: "pkg",
							Args:  []ir.FilterExpr{{Line: 725, Op: ir.FilterStringOp, Src: "`PkgName`", Value: "PkgName"}},
						},
					},
				},
			}},
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:           734,
					SyntaxPatterns: []ir.PatternString{{Line: 734, Value: "var()"}},
					ReportTemplate: "empty var() block",
				},
				{
					Line:           735,
					SyntaxPatterns: []ir.PatternString{{Line: 735, Value: "const()"}},
					ReportTemplate: "empty const() block",
				},
				{
					Line:           736,
					SyntaxPatterns: []ir.PatternString{{Line: 736, Value: "type()"}},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            744,
					SyntaxPatterns:  []ir.PatternString{{Line: 744, Value: "fmt.Errorf($f)"}},
				...
				{
					Line:            749,
					SyntaxPatterns:  []ir.PatternString{{Line: 749, Value: "fmt.Errorf($f($*args))"}},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            759,
					SyntaxPatterns:  []ir.PatternString{{Line: 759, Value: "strings.Compare($s1, $s2) == 0"}},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line: 776,
				SyntaxPatterns: []ir.PatternString{
					{Line: 777, Value: "if $err := $_($*_); $err2 != nil { $*_ }"},
					{Line: 778, Value: "if $err = $_($*_); $err2 != nil { $*_ }"},
					{Line: 779, Value: "if $*_, $err := $_($*_); $err2 != nil { $*_ }"},
				...
				WhereExpr: ir.FilterExpr{
					...
					Args: []ir.FilterExpr{
							...
							Args: []ir.FilterExpr{
								{
									...
									Value: "err",
									Args:  []ir.FilterExpr{{Line: 781, Op: ir.FilterStringOp, Src: "\"error\"", Value: "error"}},
								},
								{
									Line:  781,
									Op:    ir.FilterVarTypeImplementsOp,
						...
						},
						{
							...
							Args: []ir.FilterExpr{
								{Line: 782, Op: ir.FilterVarTextOp, Src: "m[\"err\"].Text", Value: "err"},
								{Line: 782, Op: ir.FilterVarTextOp, Src: "m[\"err2\"].Text", Value: "err2"},
							},
						},
					},
				},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:           792,
					SyntaxPatterns: []ir.PatternString{{Line: 792, Value: "$*_; sync.OnceFunc($x); $*_;"}},
				...
				{
					Line:           796,
					SyntaxPatterns: []ir.PatternString{{Line: 796, Value: "sync.OnceFunc($x)()"}},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            806,
					SyntaxPatterns:  []ir.PatternString{{Line: 806, Value: "bytes.Repeat([]byte{0}, $x)"}},
					ReportTemplate:  "avoid bytes.Repeat([]byte{0}, $x); consider using make([]byte, $x) instead",
					SuggestTemplate: "make([]byte, $x)",
				},
				{
					Line:            811,
					SyntaxPatterns:  []ir.PatternString{{Line: 811, Value: "bytes.Repeat([]byte{$x}, $n)"}},
