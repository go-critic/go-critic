		...
		ir.RuleGroup{
			...
			Rules: []ir.Rule{
				...
				ir.Rule{
					Line: 749,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 749, Value: "strings.Compare($s1, $s2) == -1"},
						ir.PatternString{Line: 750, Value: "-1 == strings.Compare($s1, $s2)"},
						ir.PatternString{Line: 751, Value: "strings.Compare($s1, $s2) < 0"},
						ir.PatternString{Line: 752, Value: "0 > strings.Compare($s1, $s2)"},
					},
					ReportTemplate:  "suggestion: $s1 < $s2",
					SuggestTemplate: "$s1 < $s2",
					LocationVar:     "s1",
				...
				ir.Rule{
					Line: 756,
					SyntaxPatterns: []ir.PatternString{
						ir.PatternString{Line: 756, Value: "strings.Compare($s1, $s2) == 1"},
						ir.PatternString{Line: 757, Value: "1 == strings.Compare($s1, $s2)"},
						ir.PatternString{Line: 758, Value: "strings.Compare($s1, $s2) > 0"},
						ir.PatternString{Line: 759, Value: "0 < strings.Compare($s1, $s2)"},
					},
					ReportTemplate:  "suggestion: $s1 > $s2",
					SuggestTemplate: "$s1 > $s2",
					LocationVar:     "s1",
