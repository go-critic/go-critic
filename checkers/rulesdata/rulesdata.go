	...
	RuleGroups: []ir.RuleGroup{
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:           667,
					SyntaxPatterns: []ir.PatternString{{Line: 667, Value: "type $x struct { $*_; sync.Mutex; $*_ }"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "isExported(m[\"x\"])",
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 664, Op: ir.FilterStringOp, Src: "`^\\p{Lu}`", Value: "^\\p{Lu}"}},
					},
				},
				{
					Line:           671,
					SyntaxPatterns: []ir.PatternString{{Line: 671, Value: "type $x struct { $*_; *sync.Mutex; $*_ }"}},
					ReportTemplate: "don't embed *sync.Mutex",
					WhereExpr: ir.FilterExpr{
						Line:  672,
						Op:    ir.FilterVarTextMatchesOp,
				...
				{
					Line:           675,
					SyntaxPatterns: []ir.PatternString{{Line: 675, Value: "type $x struct { $*_; sync.RWMutex; $*_ }"}},
				...
				{
					Line:           679,
					SyntaxPatterns: []ir.PatternString{{Line: 679, Value: "type $x struct { $*_; *sync.RWMutex; $*_ }"}},
					ReportTemplate: "don't embed *sync.RWMutex",
					WhereExpr: ir.FilterExpr{
						Line:  680,
						Op:    ir.FilterVarTextMatchesOp,
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            689,
					SyntaxPatterns:  []ir.PatternString{{Line: 689, Value: "$x = sort.IntSlice($x)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "m[\"x\"].Type.Is(`[]int`)",
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 690, Op: ir.FilterStringOp, Src: "`[]int`", Value: "[]int"}},
					},
				},
				{
					Line:            694,
					SyntaxPatterns:  []ir.PatternString{{Line: 694, Value: "$x = sort.Float64Slice($x)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 695, Op: ir.FilterStringOp, Src: "`[]float64`", Value: "[]float64"}},
					},
				},
				{
					Line:            699,
					SyntaxPatterns:  []ir.PatternString{{Line: 699, Value: "$x = sort.StringSlice($x)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "m[\"x\"].Type.Is(`[]string`)",
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 700, Op: ir.FilterStringOp, Src: "`[]string`", Value: "[]string"}},
					},
				},
			},
		},
		{
			...
			Rules: []ir.Rule{{
				Line:           710,
				SyntaxPatterns: []ir.PatternString{{Line: 710, Value: "$pkg.$err = $x"}},
					...
					Args: []ir.FilterExpr{
						{
							...
							Value: "err",
							Args:  []ir.FilterExpr{{Line: 711, Op: ir.FilterStringOp, Src: "`error`", Value: "error"}},
						},
						{
							Line:  711,
							Op:    ir.FilterVarObjectIsOp,
							Src:   "m[\"pkg\"].Object.Is(`PkgName`)",
							Value: "pkg",
							Args:  []ir.FilterExpr{{Line: 711, Op: ir.FilterStringOp, Src: "`PkgName`", Value: "PkgName"}},
						},
					},
				},
			}},
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:           720,
					SyntaxPatterns: []ir.PatternString{{Line: 720, Value: "var()"}},
					ReportTemplate: "empty var() block",
				},
				{
					Line:           721,
					SyntaxPatterns: []ir.PatternString{{Line: 721, Value: "const()"}},
					ReportTemplate: "empty const() block",
				},
				{
					Line:           722,
					SyntaxPatterns: []ir.PatternString{{Line: 722, Value: "type()"}},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            730,
					SyntaxPatterns:  []ir.PatternString{{Line: 730, Value: "fmt.Errorf($f)"}},
				...
				{
					Line:            735,
					SyntaxPatterns:  []ir.PatternString{{Line: 735, Value: "fmt.Errorf($f($*args))"}},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            745,
					SyntaxPatterns:  []ir.PatternString{{Line: 745, Value: "strings.Compare($s1, $s2) == 0"}},
				...
				},
				{
					Line: 748,
					SyntaxPatterns: []ir.PatternString{
						{Line: 748, Value: "strings.Compare($s1, $s2) == -1"},
						{Line: 749, Value: "strings.Compare($s1, $s2) < 0"},
					},
					ReportTemplate:  "suggestion: $s1 < $s2",
					SuggestTemplate: "$s1 < $s2",
				},
				{
					Line: 752,
					SyntaxPatterns: []ir.PatternString{
						{Line: 752, Value: "strings.Compare($s1, $s2) == 1"},
						{Line: 753, Value: "strings.Compare($s1, $s2) > 0"},
					},
					ReportTemplate:  "suggestion: $s1 > $s2",
					SuggestTemplate: "$s1 > $s2",
				},
