			...
			Rules: []ir.Rule{
				ir.Rule{
					...
					SyntaxPatterns: []ir.PatternString{
						...
						ir.PatternString{Line: 746, Value: "0 == strings.Compare($s1, $s2)"},
					},
				...
				ir.Rule{
					...
					SyntaxPatterns: []ir.PatternString{
						...
						ir.PatternString{Line: 754, Value: "0 > strings.Compare($s1, $s2)"},
					},
					ReportTemplate:  "suggestion: $s1 < $s2",
					SuggestTemplate: "$s1 < $s2",
					LocationVar:     "s1",
				...
				ir.Rule{
					...
					SyntaxPatterns: []ir.PatternString{
						...
						ir.PatternString{Line: 761, Value: "strings.Compare($s1, $s2) > 0"},
						ir.PatternString{Line: 762, Value: "0 < strings.Compare($s1, $s2)"},
					},
					ReportTemplate:  "suggestion: $s1 > $s2",
					SuggestTemplate: "$s1 > $s2",
					LocationVar:     "s1",
