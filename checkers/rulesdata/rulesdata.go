	...
	RuleGroups: []ir.RuleGroup{
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:           183,
					SyntaxPatterns: []ir.PatternString{{Line: 183, Value: "copy($_, []byte($s))"}},
					ReportTemplate: "can simplify `[]byte($s)` to `$s`",
				},
				{
					Line:            185,
					SyntaxPatterns:  []ir.PatternString{{Line: 185, Value: "string($b) == \"\""}},
				...
				{
					Line:            186,
					SyntaxPatterns:  []ir.PatternString{{Line: 186, Value: "string($b) != \"\""}},
					ReportTemplate:  "suggestion: len($b) != 0",
					SuggestTemplate: "len($b) != 0",
					WhereExpr: ir.FilterExpr{
						Line:  186,
				...
				{
					Line:            188,
					SyntaxPatterns:  []ir.PatternString{{Line: 188, Value: "len(string($b))"}},
				...
				{
					Line:            194,
					SyntaxPatterns:  []ir.PatternString{{Line: 194, Value: "string($x) != string($y)"}},
					ReportTemplate:  "suggestion: !bytes.Equal($x, $y)",
					SuggestTemplate: "!bytes.Equal($x, $y)",
					WhereExpr: ir.FilterExpr{
						Line: 195,
						...
						Args: []ir.FilterExpr{
							{
								...
								Src:   "m[\"x\"].Type.Is(`[]byte`)",
								Value: "x",
								Args:  []ir.FilterExpr{{Line: 195, Op: ir.FilterStringOp, Src: "`[]byte`", Value: "[]byte"}},
							},
							{
								Line:  195,
								Op:    ir.FilterVarTypeIsOp,
				...
				{
					Line:            198,
					SyntaxPatterns:  []ir.PatternString{{Line: 198, Value: "$re.Match([]byte($s))"}},
				...
				{
					Line:            202,
					SyntaxPatterns:  []ir.PatternString{{Line: 202, Value: "$re.FindIndex([]byte($s))"}},
				...
				{
					Line:            206,
					SyntaxPatterns:  []ir.PatternString{{Line: 206, Value: "$re.FindAllIndex([]byte($s), $n)"}},
						...
						Args: []ir.FilterExpr{
							{
								...
								Src:   "m[\"re\"].Type.Is(`*regexp.Regexp`)",
								Value: "re",
								Args:  []ir.FilterExpr{{Line: 207, Op: ir.FilterStringOp, Src: "`*regexp.Regexp`", Value: "*regexp.Regexp"}},
							},
							{
								Line:  207,
								Op:    ir.FilterVarTypeIsOp,
								Src:   "m[\"s\"].Type.Is(`string`)",
								Value: "s",
								Args:  []ir.FilterExpr{{Line: 207, Op: ir.FilterStringOp, Src: "`string`", Value: "string"}},
							},
						},
					},
				},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line:           217,
				SyntaxPatterns: []ir.PatternString{{Line: 217, Value: "strings.Index(string($x), $y)"}},
				...
				WhereExpr: ir.FilterExpr{
					...
					Args: []ir.FilterExpr{
						{Line: 218, Op: ir.FilterVarPureOp, Src: "m[\"x\"].Pure", Value: "x"},
						{Line: 218, Op: ir.FilterVarPureOp, Src: "m[\"y\"].Pure", Value: "y"},
					},
				},
			}},
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:           227,
					SyntaxPatterns: []ir.PatternString{{Line: 227, Value: "$wg.Add(-1)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "wg",
						Args:  []ir.FilterExpr{{Line: 228, Op: ir.FilterStringOp, Src: "`sync.WaitGroup`", Value: "sync.WaitGroup"}},
					},
				},
				{
					Line:           231,
					SyntaxPatterns: []ir.PatternString{{Line: 231, Value: "$buf.Truncate(0)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "buf",
						Args:  []ir.FilterExpr{{Line: 232, Op: ir.FilterStringOp, Src: "`bytes.Buffer`", Value: "bytes.Buffer"}},
					},
				},
				{
					Line:           235,
					SyntaxPatterns: []ir.PatternString{{Line: 235, Value: "http.HandlerFunc(http.NotFound)"}},
					ReportTemplate: "use http.NotFoundHandler method in `$$`",
				},
				{
					Line:           237,
					SyntaxPatterns: []ir.PatternString{{Line: 237, Value: "strings.SplitN($_, $_, -1)"}},
					ReportTemplate: "use strings.Split method in `$$`",
				},
				{
					Line:           238,
					SyntaxPatterns: []ir.PatternString{{Line: 238, Value: "strings.Replace($_, $_, $_, -1)"}},
					ReportTemplate: "use strings.ReplaceAll method in `$$`",
				},
				{
					Line:           239,
					SyntaxPatterns: []ir.PatternString{{Line: 239, Value: "strings.Map(unicode.ToTitle, $_)"}},
					ReportTemplate: "use strings.ToTitle method in `$$`",
				},
				{
					Line: 240,
					SyntaxPatterns: []ir.PatternString{
						{Line: 240, Value: "strings.Index($s1, $s2) >= 0"},
						{Line: 240, Value: "strings.Index($s1, $s2) != -1"},
					},
				...
				},
				{
					Line: 241,
					SyntaxPatterns: []ir.PatternString{
						{Line: 241, Value: "strings.IndexAny($s1, $s2) >= 0"},
						{Line: 241, Value: "strings.IndexAny($s1, $s2) != -1"},
					},
				...
				},
				{
					Line: 242,
					SyntaxPatterns: []ir.PatternString{
						{Line: 242, Value: "strings.IndexRune($s1, $s2) >= 0"},
						{Line: 242, Value: "strings.IndexRune($s1, $s2) != -1"},
					},
				...
				},
				{
					Line: 244,
					SyntaxPatterns: []ir.PatternString{
						{Line: 244, Value: "$i := strings.Index($s, $sep); $*_; $x, $y = $s[:$i], $s[$i+1:]"},
						{Line: 245, Value: "$i := strings.Index($s, $sep); $*_; $x = $s[:$i]; $*_; $y = $s[$i+1:]"},
					},
				...
				},
				{
					Line: 249,
					SyntaxPatterns: []ir.PatternString{
						{Line: 250, Value: "if $i := strings.Index($s, $sep); $i != -1 { $*_; $x, $y = $s[:$i], $s[$i+1:]; $*_ }"},
						{Line: 251, Value: "if $i := strings.Index($s, $sep); $i != -1 { $*_; $x = $s[:$i]; $*_; $y = $s[$i+1:]; $*_ }"},
						{Line: 252, Value: "if $i := strings.Index($s, $sep); $i >= 0 { $*_; $x, $y = $s[:$i], $s[$i+1:]; $*_ }"},
						{Line: 253, Value: "if $i := strings.Index($s, $sep); $i >= 0 { $*_; $x = $s[:$i]; $*_; $y = $s[$i+1:]; $*_ }"},
					},
				...
				{
					Line:           257,
					SyntaxPatterns: []ir.PatternString{{Line: 257, Value: "bytes.SplitN(b, []byte(\".\"), -1)"}},
					ReportTemplate: "use bytes.Split method in `$$`",
				},
				{
					Line:           258,
					SyntaxPatterns: []ir.PatternString{{Line: 258, Value: "bytes.Replace($_, $_, $_, -1)"}},
					ReportTemplate: "use bytes.ReplaceAll method in `$$`",
				},
				{
					Line:           259,
					SyntaxPatterns: []ir.PatternString{{Line: 259, Value: "bytes.Map(unicode.ToUpper, $_)"}},
					ReportTemplate: "use bytes.ToUpper method in `$$`",
				},
				{
					Line:           260,
					SyntaxPatterns: []ir.PatternString{{Line: 260, Value: "bytes.Map(unicode.ToLower, $_)"}},
					ReportTemplate: "use bytes.ToLower method in `$$`",
				},
				{
					Line:           261,
					SyntaxPatterns: []ir.PatternString{{Line: 261, Value: "bytes.Map(unicode.ToTitle, $_)"}},
					ReportTemplate: "use bytes.ToTitle method in `$$`",
				},
				{
					Line: 262,
					SyntaxPatterns: []ir.PatternString{
						{Line: 262, Value: "bytes.Index($b1, $b2) >= 0"},
						{Line: 262, Value: "bytes.Index($b1, $b2) != -1"},
					},
				...
				},
				{
					Line: 263,
					SyntaxPatterns: []ir.PatternString{
						{Line: 263, Value: "bytes.IndexAny($b1, $b2) >= 0"},
						{Line: 263, Value: "bytes.IndexAny($b1, $b2) != -1"},
					},
				...
				},
				{
					Line: 264,
					SyntaxPatterns: []ir.PatternString{
						{Line: 264, Value: "bytes.IndexRune($b1, $b2) >= 0"},
						{Line: 264, Value: "bytes.IndexRune($b1, $b2) != -1"},
					},
				...
				{
					Line:           266,
					SyntaxPatterns: []ir.PatternString{{Line: 266, Value: "draw.DrawMask($_, $_, $_, $_, nil, image.Point{}, $_)"}},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:           275,
					SyntaxPatterns: []ir.PatternString{{Line: 275, Value: "regexp.Compile($pat)"}},
				...
				{
					Line:           279,
					SyntaxPatterns: []ir.PatternString{{Line: 279, Value: "regexp.CompilePOSIX($pat)"}},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:           289,
					SyntaxPatterns: []ir.PatternString{{Line: 289, Value: "strings.Replace($_, $_, $_, $zero)"}},
				...
				{
					Line:           292,
					SyntaxPatterns: []ir.PatternString{{Line: 292, Value: "bytes.Replace($_, $_, $_, $zero)"}},
					ReportTemplate: "suspicious arg 0, probably meant -1",
					WhereExpr: ir.FilterExpr{
						Line: 293,
						Op:   ir.FilterEqOp,
				...
				{
					Line:           296,
					SyntaxPatterns: []ir.PatternString{{Line: 296, Value: "strings.SplitN($_, $_, $zero)"}},
					ReportTemplate: "suspicious arg 0, probably meant -1",
					WhereExpr: ir.FilterExpr{
						Line: 297,
						Op:   ir.FilterEqOp,
				...
				{
					Line:           299,
					SyntaxPatterns: []ir.PatternString{{Line: 299, Value: "bytes.SplitN($_, $_, $zero)"}},
					ReportTemplate: "suspicious arg 0, probably meant -1",
					WhereExpr: ir.FilterExpr{
						Line: 300,
						Op:   ir.FilterEqOp,
				...
				{
					Line:           303,
					SyntaxPatterns: []ir.PatternString{{Line: 303, Value: "append($_)"}},
					ReportTemplate: "no-op append call, probably missing arguments",
				},
				{
					Line:           305,
					SyntaxPatterns: []ir.PatternString{{Line: 305, Value: "filepath.Join($_)"}},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:           313,
					SyntaxPatterns: []ir.PatternString{{Line: 313, Value: "$x = $x + 1"}},
					ReportTemplate: "replace `$$` with `$x++`",
					WhereExpr:      ir.FilterExpr{Line: 313, Op: ir.FilterVarPureOp, Src: "m[\"x\"].Pure", Value: "x"},
				},
				{
					Line:           314,
					SyntaxPatterns: []ir.PatternString{{Line: 314, Value: "$x = $x - 1"}},
					ReportTemplate: "replace `$$` with `$x--`",
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line:           338,
				SyntaxPatterns: []ir.PatternString{{Line: 338, Value: "$w.WriteRune($c)"}},
					...
					Args: []ir.FilterExpr{
						{
							...
							Value: "w",
							Args:  []ir.FilterExpr{{Line: 339, Op: ir.FilterStringOp, Src: "\"io.ByteWriter\"", Value: "io.ByteWriter"}},
						},
						{
							Line: 339,
							Op:   ir.FilterAndOp,
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            348,
					SyntaxPatterns:  []ir.PatternString{{Line: 348, Value: "$w.Write([]byte(fmt.Sprint($*args)))"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "w",
						Args:  []ir.FilterExpr{{Line: 349, Op: ir.FilterStringOp, Src: "\"io.Writer\"", Value: "io.Writer"}},
					},
				},
				{
					Line:            353,
					SyntaxPatterns:  []ir.PatternString{{Line: 353, Value: "$w.Write([]byte(fmt.Sprintf($*args)))"}},
				...
				{
					Line:            358,
					SyntaxPatterns:  []ir.PatternString{{Line: 358, Value: "$w.Write([]byte(fmt.Sprintln($*args)))"}},
				...
				{
					Line:            363,
					SyntaxPatterns:  []ir.PatternString{{Line: 363, Value: "io.WriteString($w, fmt.Sprint($*args))"}},
					ReportTemplate:  "suggestion: fmt.Fprint($w, $args)",
					SuggestTemplate: "fmt.Fprint($w, $args)",
				},
				{
					Line:            364,
					SyntaxPatterns:  []ir.PatternString{{Line: 364, Value: "io.WriteString($w, fmt.Sprintf($*args))"}},
					ReportTemplate:  "suggestion: fmt.Fprintf($w, $args)",
					SuggestTemplate: "fmt.Fprintf($w, $args)",
				},
				{
					Line:            365,
					SyntaxPatterns:  []ir.PatternString{{Line: 365, Value: "io.WriteString($w, fmt.Sprintln($*args))"}},
					ReportTemplate:  "suggestion: fmt.Fprintln($w, $args)",
					SuggestTemplate: "fmt.Fprintln($w, $args)",
				},
				{
					Line:            367,
					SyntaxPatterns:  []ir.PatternString{{Line: 367, Value: "$w.WriteString(fmt.Sprint($*args))"}},
					ReportTemplate:  "suggestion: fmt.Fprint($w, $args)",
					SuggestTemplate: "fmt.Fprint($w, $args)",
					WhereExpr: ir.FilterExpr{
						Line: 368,
				...
				{
					Line:            370,
					SyntaxPatterns:  []ir.PatternString{{Line: 370, Value: "$w.WriteString(fmt.Sprintf($*args))"}},
					ReportTemplate:  "suggestion: fmt.Fprintf($w, $args)",
					SuggestTemplate: "fmt.Fprintf($w, $args)",
					WhereExpr: ir.FilterExpr{
						Line: 371,
				...
				{
					Line:            373,
					SyntaxPatterns:  []ir.PatternString{{Line: 373, Value: "$w.WriteString(fmt.Sprintln($*args))"}},
					ReportTemplate:  "suggestion: fmt.Fprintln($w, $args)",
					SuggestTemplate: "fmt.Fprintln($w, $args)",
					WhereExpr: ir.FilterExpr{
						Line: 374,
			...
			Rules: []ir.Rule{
				{
					Line: 383,
					SyntaxPatterns: []ir.PatternString{
						{Line: 383, Value: "$x.Equal($x)"},
						{Line: 383, Value: "$x.Equals($x)"},
						{Line: 383, Value: "$x.Compare($x)"},
						{Line: 383, Value: "$x.Cmp($x)"},
					},
					ReportTemplate: "suspicious method call with the same argument and receiver",
					WhereExpr:      ir.FilterExpr{Line: 384, Op: ir.FilterVarPureOp, Src: "m[\"x\"].Pure", Value: "x"},
				},
				{
					Line: 387,
					SyntaxPatterns: []ir.PatternString{
						{Line: 387, Value: "copy($x, $x)"},
						...
						{Line: 392, Value: "strings.Contains($x, $x)"},
						{Line: 393, Value: "strings.Compare($x, $x)"},
						{Line: 394, Value: "strings.EqualFold($x, $x)"},
						{Line: 395, Value: "strings.HasPrefix($x, $x)"},
						{Line: 396, Value: "strings.HasSuffix($x, $x)"},
						{Line: 397, Value: "strings.Index($x, $x)"},
						{Line: 398, Value: "strings.LastIndex($x, $x)"},
						{Line: 399, Value: "strings.Split($x, $x)"},
						{Line: 400, Value: "strings.SplitAfter($x, $x)"},
						{Line: 401, Value: "strings.SplitAfterN($x, $x, $_)"},
						{Line: 402, Value: "strings.SplitN($x, $x, $_)"},
						{Line: 403, Value: "strings.Replace($_, $x, $x, $_)"},
						{Line: 404, Value: "strings.ReplaceAll($_, $x, $x)"},
						{Line: 405, Value: "bytes.Contains($x, $x)"},
						{Line: 406, Value: "bytes.Compare($x, $x)"},
						{Line: 407, Value: "bytes.Equal($x, $x)"},
						{Line: 408, Value: "bytes.EqualFold($x, $x)"},
						{Line: 409, Value: "bytes.HasPrefix($x, $x)"},
						{Line: 410, Value: "bytes.HasSuffix($x, $x)"},
						{Line: 411, Value: "bytes.Index($x, $x)"},
						{Line: 412, Value: "bytes.LastIndex($x, $x)"},
						{Line: 413, Value: "bytes.Split($x, $x)"},
						{Line: 414, Value: "bytes.SplitAfter($x, $x)"},
						{Line: 415, Value: "bytes.SplitAfterN($x, $x, $_)"},
						{Line: 416, Value: "bytes.SplitN($x, $x, $_)"},
						{Line: 417, Value: "bytes.Replace($_, $x, $x, $_)"},
						{Line: 418, Value: "bytes.ReplaceAll($_, $x, $x)"},
						{Line: 419, Value: "types.Identical($x, $x)"},
						{Line: 420, Value: "types.IdenticalIgnoreTags($x, $x)"},
						{Line: 421, Value: "draw.Draw($x, $_, $x, $_, $_)"},
					},
					ReportTemplate: "suspicious duplicated args in $$",
					WhereExpr:      ir.FilterExpr{Line: 422, Op: ir.FilterVarPureOp, Src: "m[\"x\"].Pure", Value: "x"},
				},
			},
		},
		{
			...
			Rules: []ir.Rule{{
				Line:           431,
				SyntaxPatterns: []ir.PatternString{{Line: 431, Value: "if $_ { $*_; http.Error($w, $err, $code) }"}},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line:            441,
				SyntaxPatterns:  []ir.PatternString{{Line: 441, Value: "$x + string(os.PathSeparator) + $y"}},
					...
					Args: []ir.FilterExpr{
						{
							...
							Src:   "m[\"x\"].Type.Is(`string`)",
							Value: "x",
							Args:  []ir.FilterExpr{{Line: 442, Op: ir.FilterStringOp, Src: "`string`", Value: "string"}},
						},
						{
							Line:  442,
							Op:    ir.FilterVarTypeIsOp,
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            452,
					SyntaxPatterns:  []ir.PatternString{{Line: 452, Value: "$w.Write([]byte($s))"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "m[\"w\"].Type.Implements(\"io.StringWriter\")",
						Value: "w",
						Args:  []ir.FilterExpr{{Line: 453, Op: ir.FilterStringOp, Src: "\"io.StringWriter\"", Value: "io.StringWriter"}},
					},
				},
				{
					Line:            457,
					SyntaxPatterns:  []ir.PatternString{{Line: 457, Value: "io.WriteString($w, $s)"}},
					ReportTemplate:  "$w.WriteString($s) should be preferred to the $$",
					SuggestTemplate: "$w.WriteString($s)",
					WhereExpr: ir.FilterExpr{
						Line:  458,
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line:           468,
				SyntaxPatterns: []ir.PatternString{{Line: 468, Value: "for $i := 0; $i < len($xs); $i++ { $xs[$i] = $zero }"}},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line:           478,
				SyntaxPatterns: []ir.PatternString{{Line: 478, Value: "$_, $ok := $m.Load($k); if $ok { $m.Delete($k); $*_ }"}},
				...
				WhereExpr: ir.FilterExpr{
					...
					Args: []ir.FilterExpr{
						...
						},
						{
							...
							Value: "m",
							Args:  []ir.FilterExpr{{Line: 480, Op: ir.FilterStringOp, Src: "`*sync.Map`", Value: "*sync.Map"}},
						},
					},
				},
			}},
		},
		{
			...
			Rules: []ir.Rule{{
				Line:           489,
				SyntaxPatterns: []ir.PatternString{{Line: 489, Value: "fmt.Sprintf($s, $*_)"}},
					...
					Args: []ir.FilterExpr{
						{
							...
							Src:   "m[\"s\"].Text.Matches(\"^`.*\\\"%s\\\".*`$\")",
							Value: "s",
							Args:  []ir.FilterExpr{{Line: 490, Op: ir.FilterStringOp, Src: "\"^`.*\\\"%s\\\".*`$\"", Value: "^`.*\"%s\".*`$"}},
						},
						{
							Line:  491,
							Op:    ir.FilterVarTextMatchesOp,
							Src:   "m[\"s\"].Text.Matches(`^\".*\\\\\"%s\\\\\".*\"$`)",
							Value: "s",
							Args:  []ir.FilterExpr{{Line: 491, Op: ir.FilterStringOp, Src: "`^\".*\\\\\"%s\\\\\".*\"$`", Value: "^\".*\\\\\"%s\\\\\".*\"$"}},
						},
					},
				},
			}},
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            500,
					SyntaxPatterns:  []ir.PatternString{{Line: 500, Value: "$x[len($x)]"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Args: []ir.FilterExpr{
							{Line: 501, Op: ir.FilterVarPureOp, Src: "m[\"x\"].Pure", Value: "x"},
							{
								Line:  501,
								Op:    ir.FilterVarTypeIsOp,
								Src:   "m[\"x\"].Type.Is(`[]$_`)",
								Value: "x",
								Args:  []ir.FilterExpr{{Line: 501, Op: ir.FilterStringOp, Src: "`[]$_`", Value: "[]$_"}},
							},
						},
					},
				},
				...
				},
				{
					Line: 517,
					SyntaxPatterns: []ir.PatternString{
						{Line: 518, Value: "$i := strings.Index($s, $_); $_ := $slicing[:$i]"},
						{Line: 519, Value: "$i := strings.Index($s, $_); $_ = $slicing[:$i]"},
						{Line: 520, Value: "$i := bytes.Index($s, $_); $_ := $slicing[:$i]"},
						{Line: 521, Value: "$i := bytes.Index($s, $_); $_ = $slicing[:$i]"},
					},
					ReportTemplate: "Index() can return -1; maybe you wanted to do $s[:$i+1]",
					WhereExpr: ir.FilterExpr{
						Line: 522,
						...
						Src:  "m[\"s\"].Text == m[\"slicing\"].Text",
						Args: []ir.FilterExpr{
							{Line: 522, Op: ir.FilterVarTextOp, Src: "m[\"s\"].Text", Value: "s"},
							{Line: 522, Op: ir.FilterVarTextOp, Src: "m[\"slicing\"].Text", Value: "slicing"},
						},
					},
					LocationVar: "slicing",
				},
				{
					Line: 526,
					SyntaxPatterns: []ir.PatternString{
						{Line: 527, Value: "$s[strings.Index($s, $_):]"},
						{Line: 528, Value: "$s[:strings.Index($s, $_)]"},
						{Line: 529, Value: "$s[bytes.Index($s, $_):]"},
						{Line: 530, Value: "$s[:bytes.Index($s, $_)]"},
					},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line:            539,
				SyntaxPatterns:  []ir.PatternString{{Line: 539, Value: "$s[:]"}},
				...
				WhereExpr: ir.FilterExpr{
					...
					Args: []ir.FilterExpr{
						...
						},
						{
							...
							Src:   "m[\"s\"].Type.Is(`[]$_`)",
							Value: "s",
							Args:  []ir.FilterExpr{{Line: 540, Op: ir.FilterStringOp, Src: "`[]$_`", Value: "[]$_"}},
						},
					},
				},
			}},
			...
			Rules: []ir.Rule{
				{
					Line: 574,
					SyntaxPatterns: []ir.PatternString{
						{Line: 575, Value: "strings.ToLower($x) == $y"},
						{Line: 576, Value: "strings.ToLower($x) == strings.ToLower($y)"},
						{Line: 577, Value: "$x == strings.ToLower($y)"},
						{Line: 578, Value: "strings.ToUpper($x) == $y"},
						{Line: 579, Value: "strings.ToUpper($x) == strings.ToUpper($y)"},
						{Line: 580, Value: "$x == strings.ToUpper($y)"},
					},
						...
						Args: []ir.FilterExpr{
							{
								...
								Src:  "m[\"x\"].Pure && m[\"y\"].Pure",
								Args: []ir.FilterExpr{
									{Line: 581, Op: ir.FilterVarPureOp, Src: "m[\"x\"].Pure", Value: "x"},
									{Line: 581, Op: ir.FilterVarPureOp, Src: "m[\"y\"].Pure", Value: "y"},
								},
							},
							{
								Line: 581,
								...
								Args: []ir.FilterExpr{
									{Line: 581, Op: ir.FilterVarTextOp, Src: "m[\"x\"].Text", Value: "x"},
									{Line: 581, Op: ir.FilterVarTextOp, Src: "m[\"y\"].Text", Value: "y"},
								},
							},
						},
					},
				},
				{
					Line: 586,
					SyntaxPatterns: []ir.PatternString{
						{Line: 587, Value: "strings.ToLower($x) != $y"},
						{Line: 588, Value: "strings.ToLower($x) != strings.ToLower($y)"},
						{Line: 589, Value: "$x != strings.ToLower($y)"},
						{Line: 590, Value: "strings.ToUpper($x) != $y"},
						{Line: 591, Value: "strings.ToUpper($x) != strings.ToUpper($y)"},
						{Line: 592, Value: "$x != strings.ToUpper($y)"},
					},
					ReportTemplate:  "consider replacing with !strings.EqualFold($x, $y)",
					SuggestTemplate: "!strings.EqualFold($x, $y)",
					WhereExpr: ir.FilterExpr{
						...
						Args: []ir.FilterExpr{
							{
								...
								Src:  "m[\"x\"].Pure && m[\"y\"].Pure",
								Args: []ir.FilterExpr{
									{Line: 593, Op: ir.FilterVarPureOp, Src: "m[\"x\"].Pure", Value: "x"},
									{Line: 593, Op: ir.FilterVarPureOp, Src: "m[\"y\"].Pure", Value: "y"},
								},
							},
							{
								Line: 593,
								...
								Src:  "m[\"x\"].Text != m[\"y\"].Text",
								Args: []ir.FilterExpr{
									{Line: 593, Op: ir.FilterVarTextOp, Src: "m[\"x\"].Text", Value: "x"},
									{Line: 593, Op: ir.FilterVarTextOp, Src: "m[\"y\"].Text", Value: "y"},
								},
							},
						},
					},
				},
				{
					Line: 598,
					SyntaxPatterns: []ir.PatternString{
						{Line: 599, Value: "bytes.Equal(bytes.ToLower($x), $y)"},
						{Line: 600, Value: "bytes.Equal(bytes.ToLower($x), bytes.ToLower($y))"},
						{Line: 601, Value: "bytes.Equal($x, bytes.ToLower($y))"},
						{Line: 602, Value: "bytes.Equal(bytes.ToUpper($x), $y)"},
						{Line: 603, Value: "bytes.Equal(bytes.ToUpper($x), bytes.ToUpper($y))"},
						{Line: 604, Value: "bytes.Equal($x, bytes.ToUpper($y))"},
					},
						...
						Args: []ir.FilterExpr{
							{
								...
								Src:  "m[\"x\"].Pure && m[\"y\"].Pure",
								Args: []ir.FilterExpr{
									{Line: 605, Op: ir.FilterVarPureOp, Src: "m[\"x\"].Pure", Value: "x"},
									{Line: 605, Op: ir.FilterVarPureOp, Src: "m[\"y\"].Pure", Value: "y"},
								},
							},
							{
								Line: 605,
								...
								Src:  "m[\"x\"].Text != m[\"y\"].Text",
								Args: []ir.FilterExpr{
									{Line: 605, Op: ir.FilterVarTextOp, Src: "m[\"x\"].Text", Value: "x"},
									{Line: 605, Op: ir.FilterVarTextOp, Src: "m[\"y\"].Text", Value: "y"},
								},
							},
						},
					},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line: 615,
				SyntaxPatterns: []ir.PatternString{
					{Line: 616, Value: "strings.HasPrefix($lit, $s)"},
					{Line: 617, Value: "bytes.HasPrefix($lit, $s)"},
					{Line: 618, Value: "strings.HasSuffix($lit, $s)"},
					{Line: 619, Value: "bytes.HasSuffix($lit, $s)"},
					{Line: 620, Value: "strings.Contains($lit, $s)"},
					{Line: 621, Value: "bytes.Contains($lit, $s)"},
					{Line: 622, Value: "strings.TrimPrefix($lit, $s)"},
					{Line: 623, Value: "bytes.TrimPrefix($lit, $s)"},
					{Line: 624, Value: "strings.TrimSuffix($lit, $s)"},
					{Line: 625, Value: "bytes.TrimSuffix($lit, $s)"},
					{Line: 626, Value: "strings.Split($lit, $s)"},
					{Line: 627, Value: "bytes.Split($lit, $s)"},
				},
					...
					Args: []ir.FilterExpr{
						...
						},
						{
							...
							Args: []ir.FilterExpr{{
								...
								Src:   "m[\"lit\"].Node.Is(`Ident`)",
								Value: "lit",
								Args:  []ir.FilterExpr{{Line: 630, Op: ir.FilterStringOp, Src: "`Ident`", Value: "Ident"}},
							}},
						},
					},
				},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            639,
					SyntaxPatterns:  []ir.PatternString{{Line: 639, Value: "strings.Join([]string{$x, $y}, \"\")"}},
					ReportTemplate:  "suggestion: $x + $y",
					SuggestTemplate: "$x + $y",
				},
				{
					Line:            640,
					SyntaxPatterns:  []ir.PatternString{{Line: 640, Value: "strings.Join([]string{$x, $y, $z}, \"\")"}},
					ReportTemplate:  "suggestion: $x + $y + $z",
					SuggestTemplate: "$x + $y + $z",
				},
				{
					Line:            641,
					SyntaxPatterns:  []ir.PatternString{{Line: 641, Value: "strings.Join([]string{$x, $y}, $glue)"}},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            653,
					SyntaxPatterns:  []ir.PatternString{{Line: 653, Value: "$t.Unix() / 1000"}},
								...
								Args: []ir.FilterExpr{
									{
										...
										Value: "t",
										Args:  []ir.FilterExpr{{Line: 650, Op: ir.FilterStringOp, Src: "`time.Time`", Value: "time.Time"}},
									},
									{
										Line:  654,
										Op:    ir.FilterVarTypeIsOp,
				...
				{
					Line:            658,
					SyntaxPatterns:  []ir.PatternString{{Line: 658, Value: "$t.UnixNano() * 1000"}},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            673,
					SyntaxPatterns:  []ir.PatternString{{Line: 673, Value: "!$t.Before($tt)"}},
						...
						Args: []ir.FilterExpr{
							{
								...
								Src:   "m[\"t\"].Type.Is(`time.Time`)",
								Value: "t",
								Args:  []ir.FilterExpr{{Line: 670, Op: ir.FilterStringOp, Src: "`time.Time`", Value: "time.Time"}},
							},
							{
								Line:  674,
								Op:    ir.FilterVarTypeIsOp,
				...
				{
					Line:            677,
					SyntaxPatterns:  []ir.PatternString{{Line: 677, Value: "!$t.After($tt)"}},
			...
			Rules: []ir.Rule{
				{
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "isExported(m[\"x\"])",
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 688, Op: ir.FilterStringOp, Src: "`^\\p{Lu}`", Value: "^\\p{Lu}"}},
					},
				},
				{
					Line:           695,
					SyntaxPatterns: []ir.PatternString{{Line: 695, Value: "type $x struct { $*_; *sync.Mutex; $*_ }"}},
					ReportTemplate: "don't embed *sync.Mutex",
					WhereExpr: ir.FilterExpr{
						Line:  696,
						Op:    ir.FilterVarTextMatchesOp,
				...
				{
					Line:           703,
					SyntaxPatterns: []ir.PatternString{{Line: 703, Value: "type $x struct { $*_; *sync.RWMutex; $*_ }"}},
					ReportTemplate: "don't embed *sync.RWMutex",
					WhereExpr: ir.FilterExpr{
						Line:  704,
						Op:    ir.FilterVarTextMatchesOp,
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            713,
					SyntaxPatterns:  []ir.PatternString{{Line: 713, Value: "$x = sort.IntSlice($x)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "m[\"x\"].Type.Is(`[]int`)",
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 714, Op: ir.FilterStringOp, Src: "`[]int`", Value: "[]int"}},
					},
				},
				{
					Line:            718,
					SyntaxPatterns:  []ir.PatternString{{Line: 718, Value: "$x = sort.Float64Slice($x)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 719, Op: ir.FilterStringOp, Src: "`[]float64`", Value: "[]float64"}},
					},
				},
				{
					Line:            723,
					SyntaxPatterns:  []ir.PatternString{{Line: 723, Value: "$x = sort.StringSlice($x)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "m[\"x\"].Type.Is(`[]string`)",
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 724, Op: ir.FilterStringOp, Src: "`[]string`", Value: "[]string"}},
					},
				},
			},
		},
		{
			...
			Rules: []ir.Rule{{
				Line:           734,
				SyntaxPatterns: []ir.PatternString{{Line: 734, Value: "$pkg.$err = $x"}},
					...
					Args: []ir.FilterExpr{
						{
							...
							Value: "err",
							Args:  []ir.FilterExpr{{Line: 735, Op: ir.FilterStringOp, Src: "`error`", Value: "error"}},
						},
						{
							Line:  735,
							Op:    ir.FilterVarObjectIsOp,
							Src:   "m[\"pkg\"].Object.Is(`PkgName`)",
							Value: "pkg",
							Args:  []ir.FilterExpr{{Line: 735, Op: ir.FilterStringOp, Src: "`PkgName`", Value: "PkgName"}},
						},
					},
				},
			}},
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:           744,
					SyntaxPatterns: []ir.PatternString{{Line: 744, Value: "var()"}},
					ReportTemplate: "empty var() block",
				},
				{
					Line:           745,
					SyntaxPatterns: []ir.PatternString{{Line: 745, Value: "const()"}},
					ReportTemplate: "empty const() block",
				},
				{
					Line:           746,
					SyntaxPatterns: []ir.PatternString{{Line: 746, Value: "type()"}},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            754,
					SyntaxPatterns:  []ir.PatternString{{Line: 754, Value: "fmt.Errorf($f)"}},
				...
				{
					Line:            759,
					SyntaxPatterns:  []ir.PatternString{{Line: 759, Value: "fmt.Errorf($f($*args))"}},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            769,
					SyntaxPatterns:  []ir.PatternString{{Line: 769, Value: "strings.Compare($s1, $s2) == 0"}},
				...
				},
				{
					Line: 776,
					SyntaxPatterns: []ir.PatternString{
						{Line: 776, Value: "strings.Compare($s1, $s2) == 1"},
						{Line: 777, Value: "strings.Compare($s1, $s2) > 0"},
					},
					ReportTemplate:  "suggestion: $s1 > $s2",
					SuggestTemplate: "$s1 > $s2",
				},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line: 786,
				SyntaxPatterns: []ir.PatternString{
					{Line: 787, Value: "if $err := $_($*_); $err2 != nil { $*_ }"},
					{Line: 788, Value: "if $err = $_($*_); $err2 != nil { $*_ }"},
					{Line: 789, Value: "if $*_, $err := $_($*_); $err2 != nil { $*_ }"},
					{Line: 790, Value: "if $*_, $err = $_($*_); $err2 != nil { $*_ }"},
				},
				...
				WhereExpr: ir.FilterExpr{
					...
					Args: []ir.FilterExpr{
							...
							Args: []ir.FilterExpr{
								{
									...
									Value: "err",
									Args:  []ir.FilterExpr{{Line: 791, Op: ir.FilterStringOp, Src: "\"error\"", Value: "error"}},
								},
								{
									Line:  791,
									Op:    ir.FilterVarTypeImplementsOp,
						...
						},
						{
							...
							Args: []ir.FilterExpr{
								{Line: 792, Op: ir.FilterVarTextOp, Src: "m[\"err\"].Text", Value: "err"},
								{Line: 792, Op: ir.FilterVarTextOp, Src: "m[\"err2\"].Text", Value: "err2"},
							},
						},
					},
				},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:           802,
					SyntaxPatterns: []ir.PatternString{{Line: 802, Value: "$*_; sync.OnceFunc($x); $*_;"}},
				...
				{
					Line:           806,
					SyntaxPatterns: []ir.PatternString{{Line: 806, Value: "sync.OnceFunc($x)()"}},
